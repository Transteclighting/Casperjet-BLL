<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOutletTrans.aspx.cs" Inherits="frmOutletTrans" %>
                            ...
                            <asp:TemplateField HeaderText="Tran No">
                             ...
                             <asp:TemplateField HeaderText="Tran Date">
                               ...
                               <asp:TemplateField HeaderText="Outlet Name">
                                <ItemTemplate>
                                   <asp:Label ID="Branch" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Branch") %>' Width="150px
                                   "></asp:Label>
                                </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <ItemTemplate>
                                   <asp:Label ID="InvoiceAmount" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "InvoiceAmount") %>' Width="100px"></asp:Label>
                                </ItemTemplate>                                
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Bank Deposit Amount">
                                <ItemTemplate>
                                   <asp:Label ID="BankDepositAmount" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "BankDepositAmount") %>' Width="100px"></asp:Label>
                                </ItemTemplate>                                
                                    <HeaderStyle HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:TemplateField>                            
