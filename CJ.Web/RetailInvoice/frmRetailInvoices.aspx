<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmRetailInvoices.aspx.cs" Inherits="RetailInvoice_frmRetailInvoices" %>
                  ...
                  <tr>                  
                      <td style="height: 90px; width: 1285px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 693px">
                           <tr>         
                                <td class="TableLabelStyle" style="width: 10px; height: 19px; text-align: left;">
                                    Outlet</td>
                                <td style="width: 105px; height: 19px">
                                   <asp:DropDownList ID="cmbOutlet" runat="server" AutoPostBack="true" CssClass="ControlStyle" Height="17px"
                                         Width="240px" OnSelectedIndexChanged="cmbOutlet_SelectedIndexChanged" >
                                     </asp:DropDownList></td>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 54px; height: 18px">
                                      <asp:TextBox ID="txtInvoiceNo" CssClass="ControlRequiredStyle" runat="server" Width="235px"></asp:TextBox></td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                ...
                <tr>
                    <td style="width: 685px">
                       <asp:GridView ID="dvwRetailInvoices" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            Width="15px"></asp:CheckBox>
                             ...
                             <asp:TemplateField HeaderText="Invoice No">
                                <ItemTemplate>
                                   <asp:Label ID="InvoiceNo" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "InvoiceNo") %>' Width="70px"></asp:Label>
                                </ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Invoice Date">
                                <ItemTemplate>
                                   <asp:Label ID="InvoiceDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "InvoiceDate") %>' Width="70px"></asp:Label>
                                </ItemTemplate>
                                 <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                   <asp:Label ID="InvoiceAmount" runat="server"  Text='<%# DataBinder.Eval (Container.DataItem, "InvoiceAmount") %>'  Width="25px"></asp:Label>
                                </ItemTemplate>                                
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>        
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                   <asp:Label ID="Status" runat="server"  Text='<%# DataBinder.Eval (Container.DataItem, "Status") %>'  Width="85px"></asp:Label>
                                </ItemTemplate>                                
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>               
