<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDCS.aspx.cs" Inherits="frmDCS" %>
...
<%--     <asp:ScriptManager ID="ScriptManager1" runat="server">
          ...
          <div>
            <table id="Table3" runat="server" border="0" cellpadding="0" cellspacing="0"
                  style="z-index: 108; left: 8px; top: 8px; height: 1px; width: 47%;">
                  <tr>
                      <td class="PageTitleStyle" style="height: 11px; width: 646px;">
                          <asp:Label ID="lbHeaderText" runat="server" Text="Label"></asp:Label></td>
                  </tr>
                   <tr>
                    <td style="height: 24px; width: 646px;">
                    ...
                    <asp:DropDownList ID="cmbDate" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <td class="TableLabelStyle">
                                  Remarks:
                                  <asp:TextBox ID="txtRemarks" runat="server" CssClass="ControlRequiredStyle" Width="541px"></asp:TextBox></td>
                              </tr>
                    ...
                    <tr>
                      <td  class="TableHeader" style="height: 11px; width: 646px;">
                          Deposit Detail</td>
                  </tr>
                  <tr>
                    <td style="height: 84px; width: 646px;">
                      
                          <table id="Table1" bordercolor="#00cc66" style=" border: thin double;width: 643px">
                                                    
                              
                              <tr>
                                  <td class="TableLabelStyle" style="width: 1054px; height: 21px">
                                      Amount :
                                  </td>
                                  <td style="width: 1060px; height: 21px;">
                                      <asp:TextBox ID="txtDepositAmount" runat="server" CssClass="ControlRequiredStyle" 
                                          Width="146px"></asp:TextBox></td>
                                  <td class="TableLabelStyle" style="width: 1881px; height: 21px">
                                      type:
                                      <asp:DropDownList ID="cmbDepositType" runat="server" CssClass="ControlStyle"
                                          Height="17px"  Width="204px" >
                                      </asp:DropDownList></td>
                              </tr>
                              <tr>
                                  <td class="TableLabelStyle" style="width: 1054px; height: 18px">
                                      Bank:</td>
                                  <td style="width: 1060px; height: 18px">
                                      <asp:DropDownList ID="cbDepositBank" runat="server" AutoPostBack="True" CssClass="ControlStyle"
                                          Height="17px"  Width="204px" OnSelectedIndexChanged="cbBank_SelectedIndexChanged">
                                      </asp:DropDownList></td>
                                  <td class="TableLabelStyle" style="width: 1881px; height: 18px">
                                  
<%--                     <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional" >--%>
                     <ContentTemplate>
                                      Branch: &nbsp;&nbsp;
                                      <asp:DropDownList ID="cbDepositBranch" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="234px">
                                      </asp:DropDownList>
                                      </ContentTemplate>          
<%--                         </asp:UpdatePanel>    --%>
                              ...
                              <tr>
                                  ...
                                  <td class="TableLabelStyle" style="width: 1881px; height: 18px">
                                      <asp:Button ID="btAdd" runat="server" CssClass="ControlButtonStyle" 
                            Text="Add" Width="55px" OnClick="btAdd_Click"  /></td>
                              </tr>
                          </table>
                    </td>
                  </tr>
                  ...
                  <tr>                  
                      <td style="height: 65px; width: 646px;">
<%--                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional" >--%>
                     <ContentTemplate>                 
                          <asp:GridView ID="gdvDepositDetail" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" GridLines="None" OnRowDeleting="DepositDeleting" 
                            Width="640px"  AutoGenerateDeleteButton="True" >
                              <Columns>
                                <asp:TemplateField HeaderText="Bank Branch">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtBank" CssClass="ControlStyle"  Enabled=false runat="server" Width="300px"></asp:TextBox>
                                    </ItemTemplate>                
                                </asp:TemplateField>
...
<%--                         </asp:UpdatePanel> --%>
                  ...
                  <tr>
                    <td align=right class="TableLabelStyle"> 
                   ...
                   <tr>
                      <td class="TableHeader" style="height: 11px; width: 646px;">
                          <asp:Label ID="Label1" runat="server" Text="Invoice wise Collection Informatiom"></asp:Label></td>
                  </tr>
                  <tr>
                      <td style="width: 646px" >
                          <table id="Table4" bordercolor="#00cc66" style=" border: thin double; width: 643px;">
                       
                              <tr>
                                  <td class="TableLabelStyle" style="width: 872px; height: 19px">
                                      Invoice No:</td>
                                  <td style="width: 1060px; height: 19px">
                                      <asp:TextBox ID="txtInvoiceNo" runat="server" CssClass="ControlRequiredStyle" 
                                          Width="146px"></asp:TextBox></td>
                                           <td class="TableLabelStyle" style="width: 1881px; height: 19px">
                                               Date :
                                               <asp:DropDownList ID="cmbIstDate" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        Width="28%">
                                                   <asp:ListItem meta:resourceKey="ListItemResource1" Selected="True" Value="0">Day</asp:ListItem>
                                                   <asp:ListItem meta:resourceKey="ListItemResource2" Value="1">01</asp:ListItem>
                                                   <asp:ListItem meta:resourceKey="ListItemResource3" Value="2">02</asp:ListItem>
                                                   ...
                                                   <asp:ListItem meta:resourceKey="ListItemResource31" Value="30">30</asp:ListItem>
                                                   <asp:ListItem meta:resourceKey="ListItemResource32" Value="31">31</asp:ListItem>
                                               </asp:DropDownList><asp:DropDownList ID="cmbIstMonth" runat="server" CssClass="ControlStyle"
                        meta:resourcekey="cboStMonthResource1" Width="29%">
                                                   ...
                                                   <asp:ListItem meta:resourceKey="ListItemResource44" Value="11">Nov</asp:ListItem>
                                                   <asp:ListItem meta:resourceKey="ListItemResource45" Value="12">Dec</asp:ListItem>
                                               </asp:DropDownList><asp:DropDownList ID="cmbIstYear" runat="server" CssClass="ControlStyle"
                        meta:resourcekey="cboStYearResource1" Width="27%">
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 872px; height: 18px">
                                      Type:</td>
                                  <td style="width: 1060px; height: 18px">
                                   
                                      <asp:DropDownList ID="cmbType" runat="server" CssClass="ControlStyle"
                                          Height="17px"  Width="204px" AutoPostBack="True" OnSelectedIndexChanged="cmbType_SelectedIndexChanged">
                                      </asp:DropDownList>                                      
                           ...
                           <tr>
                                  <td class="TableLabelStyle" style="width: 872px; height: 18px">
                                      Bank:</td>
                                  <td style="width: 1060px; height: 18px">
                                      <asp:DropDownList ID="cmbInsBank" runat="server" AutoPostBack="True" CssClass="ControlStyle"
                                          Height="17px"  Width="204px" OnSelectedIndexChanged="cmbInsBank_SelectedIndexChanged" >
                                      </asp:DropDownList></td>
                                 <td class="TableLabelStyle" style="width: 1881px; height: 18px">                                     
<%--                       <asp:UpdatePanel ID="UpdatePanel3" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional" >--%>
                     <ContentTemplate>  
                                     Branch: &nbsp;&nbsp;
                                     <asp:DropDownList ID="cmbIstBranch" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="234px">
                                     </asp:DropDownList>
                                     </ContentTemplate>          
<%--                         </asp:UpdatePanel> --%>
                                  ...
                                  <td style="width: 1060px; height: 18px">
                                      <asp:TextBox ID="txtInsAmount" runat="server" CssClass="ControlRequiredStyle" 
                                          Width="146px"></asp:TextBox></td>
                                 <td class="TableLabelStyle" style="width: 1881px; height: 18px">
                        <asp:Button ID="btnAdd" runat="server" CssClass="ControlButtonStyle" 
                            Text="Add" Width="56px" OnClick="btnAdd_Click"  /></td>
...
<%--                       <asp:UpdatePanel ID="UpdatePanel4" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional" >--%>
                     <ContentTemplate>  
                        <asp:GridView ID="dvwInvDeposit" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" GridLines="None" OnRowDeleting="InvoiceDeleting"
                             AutoGenerateDeleteButton="True" Width="645px" >
                            <Columns>       
                                                
                            <asp:TemplateField HeaderText="Invoice No">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtInvoiceNo" CssClass="ControlStyle"  Enabled=false runat="server" Width="70px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="Instrument Type">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtInstrumentType" CssClass="ControlStyle"  Enabled=false runat="server" Width="80px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="Instrument No">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtIntrumentNo" CssClass="ControlStyle"  Enabled=false runat="server" Width="80px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="Bank/Branch">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtBank" CssClass="ControlStyle"  Enabled=false runat="server" Width="150px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="Date">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtDate" CssClass="ControlStyle"  Enabled=false runat="server" Width="80px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="Amount">
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtAmount" CssClass="ControlStyle"  Enabled=false runat="server" Width="50px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                               <asp:TemplateField HeaderText="InstrumentTypeID" Visible=False>
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtInstrumentTypeID" CssClass="ControlStyle"  Enabled=false runat="server" Width="80px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
                             
                               <asp:TemplateField HeaderText="BranchID" Visible=False>
                                    <ItemTemplate >
                                        <asp:TextBox ID="txtBranchID" CssClass="ControlStyle"  Enabled=false runat="server" Width="80px"></asp:TextBox>
                                    </ItemTemplate>                
                             </asp:TemplateField>
