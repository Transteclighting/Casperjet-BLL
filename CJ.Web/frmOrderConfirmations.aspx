<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOrderConfirmations.aspx.cs" Inherits="frmOrderConfirmations" %>
                ...
                <tr>
                    <td style="width: 800px; height: 113px">
                        &nbsp;<asp:GridView ID="dvwSalesOrders" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" 
                            Width="950px" OnRowDeleting="dvwSalesOrders_RowDeleting" AutoGenerateDeleteButton="True" >
                            <Columns>       
                            ...
                            <asp:TemplateField HeaderText="Invoice No">
                                <ItemTemplate>
                                   <asp:Label ID="InvoiceNo" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "InvoiceNo") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
