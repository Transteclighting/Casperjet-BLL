<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDCSs.aspx.cs" Inherits="frmDCSs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Daily Collection Satement</title>
                  ...
                  <tr>                  
                      <td style="height: 90px; width: 1285px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 115px; height: 18px">
                                      From Date</td>
                    ...
                    <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 115px; height: 12px">
                                      Deposit No</td>
                               
                                  <td style="width: 648px; height: 12px">
                                      <asp:TextBox ID="txtDepositNo" CssClass="ControlRequiredStyle" runat="server" Width="236px"></asp:TextBox></td>
                    ...
                    <td style="width: 800px">
                       <asp:GridView ID="dvwDeposit" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Deposit No">
                                <ItemTemplate>
                                   <asp:LinkButton ID="DepositNo" runat="server"  OnClick="EditItem" Text='<%# DataBinder.Eval (Container.DataItem, "DepositNo") %>'  Width="100px"></asp:LinkButton>
                                </ItemTemplate>                                
                            </asp:TemplateField>
                            
                             <asp:TemplateField HeaderText="Deposit Date">
                                <ItemTemplate>
                                   <asp:Label ID="DepositDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "DepositDate") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                               <asp:TemplateField HeaderText="Bank/Branch">
                                <ItemTemplate>
                                   <asp:Label ID="Branch" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Branch") %>' Width="350"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                   <asp:Label ID="Amount" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Amount") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                          
