<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTDFootFallFollowupList.aspx.cs" Inherits="frmTDFootFallFollowupList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>TD Foot Fall Followup List</title>
                    ...
                    <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                ...
                                <td class="TableLabelStyle" style="width: 123px; height: 19px; text-align: left;">
                                      Outlet:&nbsp;
                                  </td>
