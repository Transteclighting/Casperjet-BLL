<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOrderConfirmation.aspx.cs" Inherits="frmOrderConfirmation" %>
...
<body>
    ...
    <div>
        ...
        <table  class="TableLabelStyle" bordercolor="#00cc66" style=" position: absolute; border: thin double; left: 13px; width: 872px; top: 11px; height: 21px; z-index: 100;">
            <tr>
                <td >
                    Order No</td>
                <td style="width: 214px; height: 1px;">
                    <asp:TextBox ID="txtOrderNo" runat="server" CssClass="ControlStyle" Width="201px" Enabled="False" ></asp:TextBox></td>
                <td>
                    Order Date</td>
            ...
            <tr>
                ...
                <td style="width: 214px; height: 2px;">
                     <asp:TextBox ID="txtCustomerCode" runat="server" CssClass="ControlRequiredStyle" Width="147px" OnTextChanged="txtCustomerCode_TextChanged" AutoPostBack=true Enabled="False"></asp:TextBox>&nbsp;
                    <asp:Button ID="btGo" runat="server" CssClass="ControlButtonStyle" Text="Go" OnClick="btGo_Click" Width="25px" Enabled=False /></td>
                <td >
                    Customer Name</td>
                <td >
                    <asp:TextBox ID="txtCustomerName" CssClass="ControlStyle" runat="server" Width="213px" Enabled="False"></asp:TextBox></td>
            </tr>    
            <tr>
                <td >
                Order Typr:
               ...
               <td style="width: 111px; height: 21px;">
                    <asp:CheckBox ID="chkOrderType" runat="server" Text="Cash Order" AutoPostBack=true Enabled="False" /></td>
            </tr>        
         
        </table>
        <table  class="TableLabelStyle" bordercolor="#00cc66" style="z-index: 101; left: 466px; width: 424px; position: absolute; top: 111px;  border: thin double; height: 205px;">
           <tbody>
           <tr bgcolor="#C1D979">
        ...
        <table class="TableLabelStyle"  bordercolor="#66ff66" style="z-index: 102; left: 13px; width: 451px; position: absolute;top: 110px;border: thin double">
            ...
            <tr>
                ...
                <td style="width: 163px; height: 21px">
                    <asp:TextBox ID="txtCustomerAddress" runat="server" CssClass="ControlStyle" Height="37px" TextMode="MultiLine" Width="305px" Enabled="False"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 121px; height: 4px">
                    Sales Person Info</td>
                <td style="width: 163px; height: 4px">
                    <asp:DropDownList ID="cbSalesPerson" runat="server"  CssClass="ControlStyle" Width="313px" Enabled="False">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                ...
                <td style="width: 163px; height: 7px;">
                    <asp:DropDownList ID="cbWarehouseName" runat="server"  CssClass="ControlStyle" Width="311px" Enabled="False">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                ...
                <td style="width: 163px; height: 3px">
                    <asp:DropDownList ID="cbSalesPromotion" runat="server" CssClass="ControlStyle" Width="310px" Enabled="False">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 121px; height: 3px">
                    Com. DD Amount</td>
                <td style="width: 163px; height: 3px; ">
                    <asp:TextBox ID="txtDDAmount" runat="server" CssClass="ControlStyle" Enabled="False" >0.00</asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 121px; height: 4px;">
                    DD Date</td>
                ...
                <asp:DropDownList ID="cbDday" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                    ...
                    <asp:ListItem meta:resourcekey="ListItemResource32" Value="31">31</asp:ListItem>
                        ...
                        meta:resourcekey="cboStMonthResource1" Width="38%" Enabled="False">
                    <asp:ListItem meta:resourcekey="ListItemResource33" Selected="True" Value="0">Month</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource34" Value="1">Jan</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource35" Value="2">Feb</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource36" Value="3">Mar</asp:ListItem>
                    ...
                    <asp:ListItem meta:resourcekey="ListItemResource45" Value="12">Dec</asp:ListItem>
                        ...
                        meta:resourcekey="cboStYearResource1" Width="31%" Enabled="False">
                    <asp:ListItem meta:resourcekey="ListItemResource46" Selected="True" Value="0">Year</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource47" Value="1999">1999</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource48" Value="2000">2000</asp:ListItem>
                    <asp:ListItem meta:resourcekey="ListItemResource49" Value="2001">2001</asp:ListItem>
            ...
            <tr>
                ...
                <td style="width: 163px;">
                    <asp:TextBox ID="txtDDDetail" runat="server" CssClass="ControlStyle" Width="309px" Enabled="False"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 121px; height: 1px;">
                    Remarks</td>
                <td style="width: 163px; height: 1px;">
                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="ControlStyle" Width="309px" Enabled="False"></asp:TextBox></td>
            </tr>
            </tbody>
        </table>
        &nbsp;
        ...
        <table style="width: 62%; z-index: 104; left: 12px; top: 387px;" border="0" cellpadding="0" cellspacing="0">
            ...
            <asp:TemplateField HeaderText="PCode">
                <ItemTemplate >
                    <asp:TextBox ID="txtProductCode" CssClass="ControlStyle"  runat="server" Width="50px"></asp:TextBox>
                </ItemTemplate>                
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Product Name">
             ...
             <asp:TemplateField HeaderText="Unit Price">
                <ItemTemplate>
                    <asp:TextBox ID="txtUnitPrice" CssClass="GridRowText"  runat="server" Width="40px" ReadOnly=true > </asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Quantity">            
                <ItemTemplate >
                     <asp:TextBox ID="txtQty" runat="server" CssClass="GridRowText" ReadOnly=true Width="45px"></asp:TextBox>
                </ItemTemplate>                
            </asp:TemplateField>    
             <asp:TemplateField HeaderText="ConfirmQty">            
                <ItemTemplate >
                     <asp:TextBox ID="txtConfirmQty" runat="server" CssClass="GridRowText"  AutoPostBack="true"  OnTextChanged="txtQty_TextChanged" Width="45px"></asp:TextBox>
                </ItemTemplate>                
            </asp:TemplateField>    
            <asp:TemplateField HeaderText="GrossTotal">            
              ...
              <asp:TemplateField HeaderText="TP">            
               ...
               <asp:TemplateField HeaderText="Promo Disc">            
                <ItemTemplate>
                     <asp:TextBox ID="txtPromoDisc" runat="server" CssClass="GridRowText"  Width="45px" ReadOnly=true ></asp:TextBox>
                </ItemTemplate>                              
            </asp:TemplateField>
            <asp:TemplateField HeaderText="NetTotal">            
             ...
             <asp:TemplateField HeaderText="PQty">            
                <ItemTemplate>
                     <asp:TextBox ID="txtPackingQty" runat="server" CssClass="GridRowText"  Width="20px" ReadOnly=true></asp:TextBox>
                </ItemTemplate>  
            ...
            <asp:TemplateField Visible=false>            
                <ItemTemplate>
                  ...
                  <asp:Button ID="btAddNewRow" runat="server" OnClick="btAddNewRow_Click" CssClass="ControlButtonStyle" Enabled=false Text="Add New Row"
                      Width="103px" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 115px; height: 21px;">
                    <asp:TextBox ID="txtTotal" runat="server" CssClass="ControlStyle"  ReadOnly=true Width=83px Enabled="False">0.00</asp:TextBox></td>
            </tr>
             <tr>
             ...
             <tr>
                ...
                <td style="width: 168px; height: 21px; text-align:left">
                    Amount to Pay :</td>
                <td style="width: 115px; height: 21px;">
                    <asp:TextBox ID="txtAmounttoPay" CssClass="ControlStyle" runat="server" Width=83px ReadOnly=true Enabled="False">0.00</asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td style="width: 115px; height: 24px;" >
                    <asp:Button ID="btSave" CssClass="ControlButtonStyle" runat="server" Text="Confirm" OnClick="btSave_Click" Width="51px" /></td>
            </tr>
        </table> 
