<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmGiftVoucherSales.aspx.cs" Inherits="frmGiftVoucherSales" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Gift Voucher Sale Satement</title>
                      ...
                      <td style="height: 90px; width: 1285px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                              ...
                              <tr>
                                  ...
                                  <td colSpan="3" style="HEIGHT: 18px; width: 685px;">
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 171px; height: 19px">
                                      <asp:TextBox ID="txtSerialNo" CssClass="ControlRequiredStyle" runat="server" Width="150px"></asp:TextBox></td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                ...
                <tr>
                    <td style="width: 685px">
                       <asp:GridView ID="dvwGiftVouchers" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" Width="685px" >
                            <Columns>       
                                                
                            <asp:TemplateField HeaderText="Serial No" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="SerialNo" runat="server"  Text='<%# DataBinder.Eval (Container.DataItem, "SerialNo") %>'  Width="80px"></asp:Label>
                                </ItemTemplate>                                
                            </asp:TemplateField>
                            
                             <asp:TemplateField HeaderText="Sale Date" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="SaleDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "SaleDate") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                               <asp:TemplateField HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="CustomerName" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "CustomerName") %>' Width="150"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Unit Price" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="UnitPrice" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "UnitPrice") %>' Width="40"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Discount Amount" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="DiscountAmt" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "DiscountAmt") %>' Width="40"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Contact No" HeaderStyle-HorizontalAlign="Left">
                              ...
                              <asp:TemplateField HeaderText="Is Redeem?" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="IsRedeem" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "IsRedeem") %>' Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                        
                            <asp:TemplateField HeaderText="Redeem Outlet" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="RedeemOutlet" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "RedeemOutlet") %>' Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>  
