<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLeaveApplications.aspx.cs" Inherits="frmLeaveApplications" %>
       ...
       <div>
          ...
          <div>
            <table id="Table3" runat="server" border="0" cellpadding="0" cellspacing="0"
                  style="z-index: 108; left: 8px; top: 8px; height: 139px; width: 52%;">
                  <tr>
                  ...
                  <tr>                  
                      <td style="height: 90px; width: 1285px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 106px; height: 18px">
                                      From Date</td>
                                
                                  <td colspan="3" style="HEIGHT: 18px; width: 213px;">
                    <asp:DropDownList ID="cboStDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                                  ...
                                  <td class="TableLabelStyle" colspan="1" style="width: 100px; height: 18px">
                                      To Date</td>
                                  <td colspan="1" style="width: 600px; height: 18px">
                    <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 106px; height: 12px">
                                      Employee Code</td>
                               
                                  <td style="width: 403px; height: 12px">
                                      <asp:TextBox ID="txtEmployeeCode" CssClass="ControlRequiredStyle" runat="server" Width="236px"></asp:TextBox></td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 679px">
                <tr>
                ...
                <tr>
                    <td style="width: 800px">
                       <asp:GridView ID="dvwDeposit" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Employee Code">
                                <ItemTemplate>
                                   <asp:LinkButton ID="EmployeeCode" runat="server"  OnClick="EditItem" Text='<%# DataBinder.Eval (Container.DataItem, "EmployeeCode") %>'  Width="80px"></asp:LinkButton>
                                </ItemTemplate>                                
                             ...
                             <asp:TemplateField HeaderText="Employee Name">
                                <ItemTemplate>
                                   <asp:Label ID="EmployeeName" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "EmployeeName") %>' Width="200px"></asp:Label>
                                </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="From Date">
                                <ItemTemplate>
                                   <asp:Label ID="FromDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "FromDate") %>' Width="80px
                                   "></asp:Label>
                                </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <ItemTemplate>
                                   <asp:Label ID="ToDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "ToDate") %>' Width="80px"></asp:Label>
                                </ItemTemplate>                                
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                ...
                                <ItemTemplate>
                                   <asp:Label ID="Type" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Type") %>' Width="80px"></asp:Label>
                                </ItemTemplate>                                
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>                            
                            <asp:TemplateField HeaderText="Remarks">
                                <ItemTemplate>
                                   <asp:Label ID="Remarks" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Remarks") %>' Width="200px"></asp:Label>
                                </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                          
