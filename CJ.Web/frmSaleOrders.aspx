<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSaleOrders.aspx.cs" Inherits="frmSaleOrders" %>
       ...
       <div>
          ...
          <div>
            &nbsp;<table id="Table3" runat="server" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                      <td class="PageTitleStyle" style="height: 11px">
                          Sales Orders</td>
                  </tr>
                  <tr>
                  </tr>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 648px; height: 12px">
                                      <asp:TextBox ID="txtOrderNo" runat="server" Width="236px"></asp:TextBox></td>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 648px; height: 20px">
                                      <asp:TextBox ID="txtCustomerCode" runat="server" Width="237px"></asp:TextBox></td>
                              ...
                              <td class="TableLabelStyle" style="width: 6284px; height: 20px">
                                ...
                                <td style="width: 42px; height: 20px">
                                   <asp:DropDownList ID="cmbWarehouse" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="261px">
                                     </asp:DropDownList></td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0"
                style="width: 869px; height: 38%">
                <tr>
                    <td class="PageTitleStyle" style="width: 250px; height: 8px">
                        
                    </td>
                </tr>
                <tr>
                    <td class="GridHeaderStyle" style="width: 250px; height: 14px">
                        <asp:LinkButton ID="btnAdd" runat="server" CssClass="ControlLinkButtonStyle" OnClick="btnAdd_Click" >Add</asp:LinkButton></td>
                </tr>
                <tr>
                    <td style="width: 800px; height: 113px">
                        &nbsp;<asp:GridView ID="dvwSalesOrders" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" 
                            Width="948px" OnRowDeleting="dvwSalesOrders_RowDeleting" AutoGenerateDeleteButton="True" >
                            <Columns>       
                                                
                            <asp:TemplateField HeaderText="Order No">
                                <ItemTemplate>
                                   <asp:LinkButton ID="OrderNo" runat="server"  OnClick="EditItem" Text='<%# DataBinder.Eval (Container.DataItem, "OrderNo") %>'></asp:LinkButton>
                                </ItemTemplate>                                
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Customer Name">
                              ...
                              <asp:TemplateField HeaderText="Branch/Outlet Name">
                                <ItemTemplate>
                                   <asp:Label ID="BranchName" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "BranchName") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Order Date">
                                <ItemTemplate>
                                   <asp:Label ID="OrderDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderDate") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Order Crate By ">
                                <ItemTemplate>
                                   <asp:Label ID="OrderCratedBy" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderCratedBy") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="OrderConfirmedBy">
                                <ItemTemplate>
                                   <asp:Label ID="OrderConfirmedBy" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderConfirmedBy") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Order Satus">
                                <ItemTemplate>
                                   <asp:Label ID="OrderSatus" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderSatus") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Order Type">
                                <ItemTemplate>
                                   <asp:Label ID="OrderType" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderType") %>' Width="150px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
