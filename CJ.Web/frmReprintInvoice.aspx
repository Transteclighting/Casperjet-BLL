<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReprintInvoice.aspx.cs" Inherits="frmReprintInvoice" %>
    ...
    <div>
       ...
       <table  class="TableLabelStyle" bordercolor="#00cc66" >
           ...
           <tr bgcolor="#C1D979">
            ...
            <div  style="height: 9px; padding-top:10px; width: 640px;" >
                <div class="divclass">                    
                    <asp:Button ID="btProcessDelivery" runat="server" CssClass="ControlButtonStyle" Text="Reprint Process Delivery" OnClick="btProcessDelivery_Click" Visible="False" />               
                </div>         
                <div >                  
                    <asp:Button ID="btDeliveryInvoice" runat="server" CssClass="ControlButtonStyle" Text="Reprint Delivery Invoice" OnClick="btDeliveryInvoice_Click" Visible="False" />
                    <asp:Button ID="btReprintMoneyCollection" runat="server" CssClass="ControlButtonStyle" Text="Reprint Money Collection" OnClick="btReprintMoneyCollection_Click" Visible="False" /></div>   
                </div>
        <div>
