<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmExchangeOfferStatus.aspx.cs" Inherits="ExchangeOffer_frmExchangeOfferStatus" %>
...
<body>
    ...
    <div>
            <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                      <td class="PageTitleStyle" style="height: 11px; width: 644px;">
                      <asp:Label ID="lbHeaderText" runat="server" Text="Exchange Offer Status"></asp:Label></td>                    
                                            
                  </tr>
                   <tr>
                    <td style="height: 24px; width: 644px;">
                      
                          <table id="Table4" runat="server" bordercolor="#00cc66" style=" border: thin double;width: 641px">

                          <tr>
                                   <td class="TableLabelStyle" style="width: 55px; height: 19px">
                                   <asp:Label ID="lblExchangeOfferCode" runat="server" Text="Code No"></asp:Label></td>  
                                   <td class="TableLabelStyle" style="width: 234px; height: 19px">
                                   <asp:Label ID="lblCodeNo" runat="server" Text="Label"></asp:Label></td>  
                           </tr>
                           <tr>      
                                   <td class="TableLabelStyle" style="width: 55px; height: 19px">
                                   <asp:Label ID="Label4" runat="server" Text="Customer Name:"></asp:Label></td>  
                                   <td class="TableLabelStyle" style="width: 234px; height: 19px">
                          ...
                          <tr>      
                                   <td class="TableLabelStyle" style="width: 55px; height: 19px">
                                   <asp:Label ID="Label6" runat="server" Text="Contact No:"></asp:Label></td>  
                                   <td class="TableLabelStyle" style="width: 234px; height: 19px">
                          ...
                          <table id="Table3" runat="server" bordercolor="#00cc66" style=" border: thin double;width: 641px">
                          <tr> </tr>
                          <tr> </tr>
                          <tr> </tr>
                          <tr>
                           <td class="TableLabelStyle" style="width: 36px; height: 22px">
                                   <asp:Label ID="Label1" runat="server" Text="Status:"></asp:Label></td>  
                           <td style="width: 180px; height: 22px">
                                   <asp:DropDownList ID="cmbStatus" runat="server" AutoPostBack="True" CssClass="ControlStyle" Height="17px"
                                   Width="163px" OnSelectedIndexChanged="cmbStatus_SelectedIndexChanged">
                           </asp:DropDownList></td>
                           </tr>   
                          <tr> </tr>
                          <tr> </tr>
                          ...
                          <table id="Table2" runat="server" bordercolor="#00cc66" style=" border: thin double;width: 641px">
                          <tr>
                          <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                   <asp:Label ID="Label2" runat="server" Text="Vender:"></asp:Label></td>  
                           <td style="width: 180px; height: 19px">
                                   <asp:DropDownList ID="cmbVender" runat="server" AutoPostBack="True" CssClass="ControlStyle" Height="17px"
                                   Width="258px">
                           </asp:DropDownList></td>   
                    ...
                    <asp:DropDownList ID="cmbDate" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                               ...
                               <tr>
                                  <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                   <asp:Label ID="lblInvoiceNo" runat="server" Text="Invoice No:"></asp:Label></td>  
                                  <td style="width: 270px; height: 19px">
                                  <asp:TextBox ID="txtInvoiceNo" runat="server" CssClass="ControlRequiredStyle" Width="180px"></asp:TextBox></td>
                              </tr>
                             <tr>
                              <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                  Money Receipt No:</td>
                                  ...
                                  <asp:DropDownList ID="cmbMoneyReceipt" runat="server" CssClass="ControlStyle" Height="17px"
                                   Width="163px" >
                           </asp:DropDownList>
                             ...
                             <tr>
                              <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                  Money Receipt Amount:</td>
                                  <td style="width: 270px; height: 19px">

                                  <asp:TextBox ID="txtMoneyReceiptAmount" runat="server" CssClass="ControlRequiredStyle" Width="180px"></asp:TextBox></td>
                              ...
                              <tr>
                               <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                   Satisfaction:</td>
                                <td class="TableLabelStyle" style="width: 370px; height: 19px;">

                                <asp:RadioButton ID="rdoHappy" runat="server" AutoPostBack="true" OnCheckedChanged="rdoHappy_CheckedChanged"
                                Text="Happy" Checked="True" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdoSatisfy" runat="server" AutoPostBack="true" OnCheckedChanged="rdoSatisfy_CheckedChanged"
                                Text="Satisfy" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdoNotHappy" runat="server" AutoPostBack="true" OnCheckedChanged="rdoNotHappy_CheckedChanged"
                                Text="Not Happy"/>
                                ...
                                <asp:RadioButton ID="rdoPrice" runat="server" AutoPostBack="true" OnCheckedChanged="rdoPrice_CheckedChanged"
                                Text="Price" Checked="True" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdoInfoLater" runat="server" AutoPostBack="true" OnCheckedChanged="rdoInfoLater_CheckedChanged"
                                Text="Not agreed" />
                                </td>
                                </tr>
                                <tr>
                                <td class="TableLabelStyle" style="width: 5375px; height: 19px; text-align: inherit;">
                                    ...
                                    <asp:CheckBox ID="chkPrice" runat="server" AutoPostBack="false" Checked="false" Text="Price is not appropriate"></asp:CheckBox>&nbsp;<br />
                                    <asp:CheckBox ID="chkDelay" runat="server" AutoPostBack="false" Checked="false" Text="Delay in response"></asp:CheckBox>&nbsp;<br />
                                    <asp:CheckBox ID="chkCommu" runat="server" AutoPostBack="false" Checked="false" Text="Communication Gap"></asp:CheckBox>&nbsp;<br />
                                    <asp:CheckBox ID="chkComit" runat="server" AutoPostBack="false" Checked="false" Text="Lack of commitment"></asp:CheckBox>
                                    </td>
                                </tr>  
                               <tr>
                                  <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                  ...
                                  <td colspan="3" style="HEIGHT: 18px; width: 600px;">
                    <asp:DropDownList ID="cmbDate1" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        Width="13%">
                        <asp:ListItem meta:resourcekey="ListItemResource1" Selected="True" Value="0">Day</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource2" Value="1">01</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource3" Value="2">02</asp:ListItem>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource31" Value="30">30</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource32" Value="31">31</asp:ListItem>
                    </asp:DropDownList><asp:DropDownList ID="cmbMonth1" runat="server" CssClass="ControlStyle"
                        meta:resourcekey="cboStMonthResource1" Width="11%">
                        <asp:ListItem meta:resourcekey="ListItemResource33" Selected="True" Value="0">Month</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource34" Value="1">Jan</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource35" Value="2">Feb</asp:ListItem>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource44" Value="11">Nov</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource45" Value="12">Dec</asp:ListItem>
                    </asp:DropDownList><asp:DropDownList ID="cmbYear1" runat="server" CssClass="ControlStyle"
                        meta:resourcekey="cboStYearResource1" Width="13%">
                        <asp:ListItem meta:resourcekey="ListItemResource46" Selected="True" Value="0">Year</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource47" Value="1999">1999</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource48" Value="2000">2000</asp:ListItem>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                               ...
                               <td class="TableLabelStyle" style="width: 5375px; height: 19px">
                                  ...
                                  <td style="width: 270px; height: 19px">
                                  <asp:TextBox ID="txtRemarks" runat="server" CssClass="ControlRequiredStyle" Width="497px"></asp:TextBox></td>
                              </tr>
                  ...
                  <tr>
                            ...
                            <td align="right" style="width: 644px">
