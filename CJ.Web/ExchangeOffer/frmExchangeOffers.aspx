<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmExchangeOffers.aspx.cs" Inherits="ExchangeOffer_ExchangeOffers" %>
            ...
            <table id="Table3" runat="server" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                      <td class="MenuStyle" style="width: 1285px;">
                          ...
                          |
                          <asp:LinkButton ID="lbStatusUpdate" runat="server" CssClass="LinkButtonStyle" Height="14px"
                              meta:resourcekey="lnkShowReportBResource1" OnClick="lbStatusUpdate_Click" >Status Update</asp:LinkButton>&nbsp;
                          |
                          <asp:LinkButton ID="lbPrint" runat="server" CssClass="LinkButtonStyle" Height="14px"
                              meta:resourcekey="lnkShowReportBResource1" OnClick="lbPrint_Click" >Print</asp:LinkButton></td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                ...
                <tr>
                    <td style="width: 685px">
                       <asp:GridView ID="dvwExchangeOffers" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Code No" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:LinkButton ID="CodeNo" runat="server"  OnClick="EditItem" Text='<%# DataBinder.Eval (Container.DataItem, "CodeNo") %>'  Width="100px"></asp:LinkButton>
                                </ItemTemplate>                                
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                           
                             <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="Date" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Date") %>' Width="70px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="CustomerName" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "CustomerName") %>' Width="110"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                              <asp:TemplateField HeaderText="Address" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="Address" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Address") %>' Width="180"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
