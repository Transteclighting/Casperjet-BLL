<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExchangeOffer.aspx.cs" Inherits="ExchangeOffer_ExchangeOffer" %>
...
<body>
    ...
    <div>
                   ...
                   <tr>
                    <td style="height: 24px; width: 642px;">
                          ...
                          <tr>
                                   ...
                                   <asp:Label ID="lblExchangeOfferCode" runat="server" Text="Label"></asp:Label></td>  
                                   <td class="TableLabelStyle" style="width: 234px; height: 19px">
                                   <asp:Label ID="lblExchangeOfferCodetext" runat="server" Text="Label"></asp:Label></td>  
                          </tr>
                    ...
                    <asp:DropDownList ID="cmbDate" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdoCall" runat="server" AutoPostBack="True" OnCheckedChanged="rdoCall_CheckedChanged"
                                Text="Call" Checked="True" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdoWalkin" runat="server" AutoPostBack="True" OnCheckedChanged="rdoIn_CheckedChanged"
                                Text="Walk-In" /></td>
                              ...
                              <td class="TableLabelStyle" style="width: 5902px; height: 19px">
                                  ...
                                  <asp:TextBox ID="txtCustomerName" runat="server" CssClass="ControlRequiredStyle" Width="400px"></asp:TextBox><asp:Label ID="Label1" runat="server" ForeColor="Red" Text="*"></asp:Label></td>
                              </tr>
                              <tr>
                              <td class="TableLabelStyle" style="width: 5902px; height: 19px">
                                  Address:</td>
                                  <td style="width: 270px; height: 19px">
                                  <asp:TextBox ID="txtAddress" runat="server" CssClass="ControlRequiredStyle" Width="400px"></asp:TextBox><asp:Label ID="Label3" runat="server" ForeColor="Red" Text="*"></asp:Label></td>
                              </tr>
                              <tr>
                              <td class="TableLabelStyle" style="width: 5902px; height: 19px">
                                  Contact No:</td>
                              ...
                              <td class="TableLabelStyle" style="width: 5902px; height: 19px">
                                  Remarks:</td>
                                  <td style="width: 270px; height: 19px">
                                  <asp:TextBox ID="txtRemarks" runat="server" CssClass="ControlRequiredStyle" Width="517px"></asp:TextBox></td>
                              </tr>
         ...
         <td width="250px" >
          ...
          <asp:GridView ID="gvwProductDetail" runat="server" AutoGenerateColumns="False" CaptionAlign="Top"
        ...
        <Columns> 
           ...
           <asp:TemplateField>
                ...
                <ItemTemplate>
                    ...
                    <asp:CheckBox ID="chkProduct" Checked='<%# DataBinder.Eval (Container.DataItem,"IsCheckProduct") %>' runat="server" 
                ...
                <asp:TemplateField HeaderText="Product Detail" >
                 ...
                 <ItemTemplate>
                 <asp:TextBox ID="txtQty" runat="server" CssClass="ControlRequiredStyle" Text='<%# DataBinder.Eval (Container.DataItem, "Qty") %>'
                 Width="30px"></asp:TextBox></td>
                </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="Size/Capacity" >
                 <ItemTemplate>
                 <asp:TextBox ID="txtSize" runat="server" CssClass="ControlRequiredStyle" Text='<%# DataBinder.Eval (Container.DataItem, "Size") %>'
                 ...
                 <ItemTemplate>
                 <asp:TextBox ID="txtBrand" runat="server" CssClass="ControlRequiredStyle" Text='<%# DataBinder.Eval (Container.DataItem, "Brand") %>'
                 Width="130px"></asp:TextBox></td>
                </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="Have Remote" >
                 <ItemTemplate>
                     <asp:DropDownList ID="cmbHaveRemote" runat="server" AutoPostBack="false" CssClass="ControlStyle" meta:resourcekey="cmbHaveRemoteResource11" Height="17px"
                       Width="70px" >
                        <asp:ListItem meta:resourcekey="ListItemResource20000" Selected="True" Value="10">Select</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource20001" Value="0">NA</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource20002" Value="1">No</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource20003" Value="2">Yes</asp:ListItem>                      
                     </asp:DropDownList></td>
                </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                 </asp:TemplateField>
                 ...
                 <ItemTemplate>
                     <asp:DropDownList ID="cmbCondition" runat="server" AutoPostBack="false" CssClass="ControlStyle" meta:resourcekey="cmbHaveRemoteResource12" Height="17px"
                       Width="90px" >
                       <asp:ListItem meta:resourcekey="ListItemResource200010" Selected="True" Value="11">Select</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource20011" Value="0">Functional</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource20012" Value="1">Dead</asp:ListItem>
                     </asp:DropDownList></td>
                </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                 </asp:TemplateField>
                 ...
                 <ItemTemplate>
                    <asp:Label ID="txtPID" runat="server" Visible="false" Text='<%# DataBinder.Eval (Container.DataItem, "PID") %>'
