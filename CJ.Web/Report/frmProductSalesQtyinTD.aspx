<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmProductSalesQtyinTD.aspx.cs" Inherits="Report_frmProductSalesQtyinTD" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Sales Quantity Outlet Wise [68]</TD>
        </TR>
        <TR>
