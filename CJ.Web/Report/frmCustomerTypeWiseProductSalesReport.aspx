<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerTypeWiseProductSalesReport.aspx.cs" Inherits="Report_frmCustomerTypeWiseProductSalesReport" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Sales Quantity and Value CustomerType Wise [64]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 695px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 166px;">
                    Product Group</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbProductType" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 70px;">
                    Channel</TD>
                <TD style="HEIGHT: 8px" width="5"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbChannel" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <%--<TD class="TableLabelStyle" style="HEIGHT: 8px; width: 104px;">
                    Area</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbArea" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>--%>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 166px;">
                    CustomerType</TD>
                <TD style="HEIGHT: 8px" width="5"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbCustomerType" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="260px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 166px;">
                    Brand</TD>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 112px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlRequiredStyle" Width="273px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 166px;">
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 112px;">
                    AG</TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="273px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 166px;">
                ...
                <TD style="HEIGHT: 20px; width: 147px;">
                    <asp:textbox id="txtCode" tabIndex="3" runat="server" CssClass="ControlRequiredStyle" Width="253px"></asp:textbox></TD>
                <TD style="HEIGHT: 20px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 70px;">
                    </TD>
                <TD style="HEIGHT: 20px" width="5"></TD>
                <TD style="width: 190px; height: 20px;"></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 166px;">
                    Area Like</TD>
