<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmInvoiceNCollectionRegister.aspx.cs" Inherits="Report_frmInvoiceNCollectionRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Invoice and Collection register</title>
        ...
        <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 93%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Invoice and Collection Register [52]</TD>
          </TR>
          <TR>
