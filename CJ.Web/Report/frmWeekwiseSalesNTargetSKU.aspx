<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmWeekwiseSalesNTargetSKU.aspx.cs" Inherits="Report_frmWeekwiseSalesNTargetSKU" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 271px;" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Week wise Daily Sales Report SKU wise [66]</TD>
        </TR>
        <TR>
              ...
              <TR>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 18px; width: 576px;">
                        <asp:DropDownList ID="cmbASG" runat="server" AutoPostBack="True" CssClass="ControlStyle"
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 18px; width: 576px;">
                        <asp:DropDownList ID="cmbBrand" runat="server" CssClass="ControlStyle" TabIndex="2"
                            Width="283px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
