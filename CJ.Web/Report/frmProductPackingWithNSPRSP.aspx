<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmProductPackingWithNSPRSP.aspx.cs" Inherits="Report_frmProductPackingWithNSPRSP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Product Packing With NSP And RSP</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Packing With NSP And RSP [104]</TD>
        </TR>
        <TR>
          ...
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 821px">
              ...
              <TR>
                ...
                <tr>
                    <td class="TableLabelStyle" style="width: 114px; height: 7px">
                        Is Active</td>
                    ...
                    <td class="TableLabelStyle" style="width: 95px; height: 7px">
                        VAT Applicable</td>
