<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDateRangeWiseCustomerBalanceStatementCustomerWise.aspx.cs" Inherits="Report_frmDateRangeWiseCustomerBalanceStatementCustomerWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Date Range Wise Customer Balance Statement Customer Wise</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0"  runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
              Date Range Wise Customer Balance Statement Customer Wise [811]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 741px">
             <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 152px;">
                    SBU</TD>
                ...
                <TD style="HEIGHT: 8px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 64px;">
                    Channel</TD>
                <TD style="HEIGHT: 8px; width: 5px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbChannel" tabIndex="41" runat="server" CssClass="ControlStyle" Width="260px">
                </asp:dropdownlist></TD>
              </TR>
               <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 152px;">
                    Customer Type</TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbCustomerType" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 64px;">
                    Area</TD>
               ...
               <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 152px;">
                    Territory</TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbTerritory" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px;"></TD>
                <%--<TD class="TableLabelStyle" style="HEIGHT: 8px; width: 64px;">
                    Area</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="Dropdownlist2" tabIndex="41" runat="server" CssClass="ControlStyle" Width="260px">
                </asp:dropdownlist></TD>--%>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 152px;">
                    Customer Code</TD>
                <TD style="HEIGHT: 18px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px"><asp:textbox id="txtCode" tabIndex="3" runat="server" CssClass="ControlStyle" Width="253px"></asp:textbox></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 18px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px"><asp:textbox id="txtRefCode" tabIndex="3" runat="server" CssClass="ControlStyle" Width="253px"></asp:textbox></TD>
                <TD style="HEIGHT: 18px; width: 5px;"></TD>
                <TD align="left" style="HEIGHT: 18px; width: 190px;"></TD>
              </TR>
              <TR>
                ...
                <TD style="HEIGHT: 18px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px"><asp:textbox id="txtRefName" tabIndex="3" runat="server" CssClass="ControlStyle" Width="254px"></asp:textbox></TD>
                <TD style="HEIGHT: 18px; width: 5px;"></TD>
                <TD align="left" style="HEIGHT: 18px; width: 190px;"></TD>
              </TR>
                <tr>
                    <td class="TableLabelStyle" style="width: 152px; height: 8px">
                    </td>
                    <td style="height: 8px">
                    </td>
                    ...
                    <td class="TableLabelStyle" style="width: 64px; height: 8px">
                    </td>
