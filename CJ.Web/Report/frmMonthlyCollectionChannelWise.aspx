<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMonthlyCollectionChannelWise.aspx.cs" Inherits="Report_frmMonthlyCollectionChannelWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Monthly Collection Channel Wise Report</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Outstanding Statement with Collection and Adjustment Channel Wise [242]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 108px;">
                    Channel Code</TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD style="HEIGHT: 7px; width: 138px;">
                    <asp:textbox id="txtCode" tabIndex="3" runat="server" CssClass="ControlRequiredStyle" Width="256px"></asp:textbox></TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD style="width: 2px"></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 108px;">
                    Channel Name Like</TD>
                <TD style="HEIGHT: 18px; width: 1px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px">
                    <asp:TextBox ID="txtName" runat="server" CssClass="ControlRequiredStyle" Width="256px"></asp:TextBox></TD>
                <TD style="HEIGHT: 18px; width: 1px;"></TD>
              ...
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 108px;">
                ...
                <TD colSpan="3" style="HEIGHT: 18px">
                    <asp:DropDownList ID="cboStDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        meta:resourcekey="cboStMonthResource1" Width="27%">
                        ...
                        meta:resourcekey="cboStYearResource1" Width="25%">
