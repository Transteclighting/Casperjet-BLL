<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmYearlyMonthwiseSalesVsCollectionRefCustomerWise.aspx.cs" Inherits="Report_frmMonthlySalesVSCollectionRefCustomerWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Monthly Sales VS Collection Ref Customer Wise</title>
  ...
  <body>
    <form id="Form1" method="post" runat="server">
        ...
        <TABLE id="Table1" cellSpacing="0" runat="server" cellPadding="0" border="0" style="width: 93%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Yearly Month Wise Sales VS Collection Parent Customer Wise [234]</TD>
          </TR>
          <TR>
