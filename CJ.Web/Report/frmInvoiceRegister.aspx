<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmInvoiceRegister.aspx.cs" Inherits="Report_frmInvoiceRegister" %>
...
<HTML>
  ...
  <body>
    <form id="Form1" method="post" runat="server">
        ...
        <TABLE id="Table2" cellSpacing="0" cellPadding="0" runat="server" border="0" style="width: 93%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Invoice Register [90]</TD>
          </TR>
          <TR>
          ...
          <TR>
            <TD style="width: 910px">
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 943px">
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 7px">
                          &nbsp;SBU</td>
                      <td style="height: 7px; width: 11px;">
                      </td>
                      <td class="TableLabelStyle" style="width: 2731px; height: 10%">
                  ...
                  <tr>
                      ...
                      <td style="width: 2731px; height: 7px">
                      </td>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 2158px;">
                    &nbsp;Customer Code</TD>
                <TD style="HEIGHT: 7px; width: 11px;"></TD>
                <TD style="HEIGHT: 7px; width: 2731px;">
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 2158px;">
              ...
              <TR>
                ...
                <TD style="HEIGHT: 7px; width: 11px;"></TD>
                <TD style="HEIGHT: 7px; width: 2731px;">
                    <asp:TextBox ID="txtRefCode" runat="server" CssClass="ControlStyle" TabIndex="3" Width="256px"></asp:TextBox></TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <%--<TD class="TableLabelStyle" style="HEIGHT: 7px; width: 70px;">
                    Brand</TD>
                <TD style="HEIGHT: 7px" width="5"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 18px; width: 11px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px"><asp:textbox id="txtRefName" tabIndex="3" runat="server" CssClass="ControlStyle" Width="256px"></asp:textbox></TD>
                <TD style="HEIGHT: 18px; width: 1px;"></TD>
              </TR>
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 7px">
                  ...
                  <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 2158px;">
                    &nbsp;Order Confirmed By Name </TD>
                <TD style="HEIGHT: 20px; width: 11px;"></TD>
                <TD colSpan="3" style="HEIGHT: 20px"><asp:textbox id="txtConfirmed" tabIndex="3" runat="server" CssClass="ControlStyle" Width="256px"></asp:textbox></TD>
              </TR>
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 19px">
                      </td>
                      <td style="height: 19px; width: 11px;">
                      </td>
                      <td class="TableLabelStyle" style="width: 2731px; height: 19px">
                      </td>
                  ...
                  <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 2158px;">
                    &nbsp;Credit Released By Name </TD>
                <TD style="HEIGHT: 20px; width: 11px;"></TD>
                <TD colSpan="3" style="HEIGHT: 20px"><asp:textbox id="txtCredit" tabIndex="3" runat="server" CssClass="ControlStyle" Width="256px"></asp:textbox></TD>
              </TR>
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 19px">
                      </td>
                  ...
                  <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 2158px;">
                    &nbsp;Delivered By Name </TD>
                <TD style="HEIGHT: 20px; width: 11px;"></TD>
                <TD colSpan="3" style="HEIGHT: 20px"><asp:textbox id="txtDelivered" tabIndex="3" runat="server" CssClass="ControlStyle" Width="256px"></asp:textbox></TD>
              </TR>
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 19px">
                      </td>
                ...
                <TR>
                  <TD class="TableLabelStyle" style="width: 2158px; height: 20px"><asp:RadioButton ID="Invoice" runat="server" Width="100%" Text="Invoice" BorderStyle="None" CssClass="ControlStyle" EnableTheming="True" GroupName="CustBal" Height="8px" Checked="True" /></TD>
                  <TD style="height: 20px; width: 11px;"></TD>
                  <TD class="TableLabelStyle" style="width: 2731px; height: 20px;">
                      &nbsp;</TD>
                </TR>
                 <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 7px">
                  ...
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 20px">
                      <asp:RadioButton ID="InvoiceDetail" runat="server" Width="100%" Text="Invoice Detail" BorderStyle="None" CssClass="ControlStyle" EnableTheming="True" GroupName="CustBal" Height="8px" /></td>
                      <td style="height: 20px; width: 11px;">
                      </td>
                      <td class="ErrorMessageStyle" style="width: 2731px; height: 20px">
                          </td>
                      <td style="width: 4728px; height: 20px" class="TableLabelStyle">
                          </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <td style="width: 2731px; height: 10%">
                        <asp:Label ID="lblToDateError" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            meta:resourcekey="lblDateErrorResource1" Width="83%"></asp:Label></td>
                      <td style="width: 7327px; height: 8px">
                      </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 2158px; height: 8px">
