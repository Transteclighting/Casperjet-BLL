<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerWiseProductSalesReport.aspx.cs" Inherits="Report_frmCustomerWiseProductSalesReport" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Sales Quantity and Value Customer Wise [61]</TD>
        </TR>
        <TR>
          ...
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbSBU" tabIndex="41" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                ...
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbChannel" tabIndex="39" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 200px;">
                    CustomerType</TD>
                <TD style="HEIGHT: 14px; width: 1px;"></TD>
                <TD style="HEIGHT: 14px; width: 147px;"><asp:dropdownlist id="cmbCustomerType" tabIndex="38" runat="server" CssClass="ControlStyle" Width="261px">
                </asp:dropdownlist></TD>
                <TD style="HEIGHT: 14px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 70px;">
                    Territory</TD>
              ...
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 112px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 200px;">
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 112px;">
                    AG</TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
               <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 70px;">
                    Warehouse</TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbWareHouse" tabIndex="41" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
