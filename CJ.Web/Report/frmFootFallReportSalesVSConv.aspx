<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFootFallReportSalesVSConv.aspx.cs" Inherits="Report_frmFootFallReportSalesVSConv" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Monthly/Weekly FootFall Report Sales VS Conversion[654]</TD>
        </TR>
        <TR>
