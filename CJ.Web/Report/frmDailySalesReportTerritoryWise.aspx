<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDailySalesReportTerritoryWise.aspx.cs" Inherits="Report_frmDailySalesReportTerritoryWise" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Daily Sales Report Territory Wise [703]</TD>
        </TR>
        <TR>
            ...
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              ...
              <TR>
                ...
                <TD style="HEIGHT: 7px; width: 147px;">
                    <asp:TextBox ID="txtTerritoryCode" runat="server" CssClass="ControlStyle" TabIndex="3" Width="258px"></asp:TextBox></TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
