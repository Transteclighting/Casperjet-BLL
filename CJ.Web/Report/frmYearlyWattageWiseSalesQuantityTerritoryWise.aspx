<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmYearlyWattageWiseSalesQuantityTerritoryWise.aspx.cs" Inherits="Report_frmYearlyWattageWiseSalesQuantityTerritoryWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Yearly Month Wise SKU Report Territory Wise</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
              Yearly Month Wise SKU Report Territory Wise [43]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 693px">
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 6602px;">
                    Channel </TD>
                <TD style="HEIGHT: 8px"></TD>
                <TD style="HEIGHT: 8px; width: 648px;"><asp:dropdownlist id="cmbChannel" tabIndex="41" runat="server" CssClass="ControlStyle" Width="244px">
                </asp:dropdownlist></TD>
              </TR>
               <tr>
                  ...
                  <td style="width: 648px; height: 12px">
                     ...
                     <td class="TableLabelStyle" style="height: 12px; width: 6602px;">
                      Territory</td>
                  <td style="height: 12px;">
                  </td>
                  <td style="width: 648px; height: 12px">
                      <asp:DropDownList ID="cmbTerritory" runat="server" Width="244px" meta:resourcekey="cmbFromAreaDescResource1" CssClass="ControlStyle">
                      </asp:DropDownList></td>                      
                </tr>
                <tr>
                ...
                <TD style="width: 648px; height: 20px;"><asp:dropdownlist id="cmbBrand" tabIndex="40" runat="server" CssClass="ControlStyle" Width="244px">
                  ...
                  <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 6602px;">
                          Product Group</TD>
                <TD style="HEIGHT: 7px"></TD>
                <TD style="width: 648px"><asp:dropdownlist id="cmbProductType" tabIndex="40" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
                                           
                </tr>
              <TR>
                <TD style="HEIGHT: 20px; width: 6602px;" class="TableLabelStyle">
                    MAG</TD>
                <TD class="TableLabelStyle" style="HEIGHT: 20px;">
                    </TD>
                <TD style="width: 648px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 6284px;">
                    ASG</TD>
                <TD style="HEIGHT: 8px; width: 43px;"></TD>
              ...
              <TR>
                <TD style="HEIGHT: 8px; width: 6602px;" class="TableLabelStyle">
                    AG</TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px;">
                    </TD>
                <TD style="HEIGHT: 8px; width: 648px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 7px; width: 6602px;"></TD>
              ...
              <TR>
                ...
                <TD align="left" style="HEIGHT: 18px; width: 648px;"></TD>
              </TR>
               <TR>
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 6284px;">
                  As of Date
                ...
                <TD align="left" style="HEIGHT: 18px; width: 648px;">
