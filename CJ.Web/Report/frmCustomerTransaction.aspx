<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerTransaction.aspx.cs" Inherits="Report_frmCustomerTransaction" %>
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 97%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Customer Transaction Ledger [800]</TD>
          </TR>
          <TR>
            ...
            <TD style="width: 910px">
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 673px">
                ...
                <TR>
                  ...
                  <TD class="TableLabelStyle" style="height: 24px;" colspan="3">
                     <asp:TextBox ID="txtCustomerCode" runat="server" CssClass="ControlRequiredStyle" Width="147px"  AutoPostBack=true OnTextChanged="txtCustomerCode_TextChanged"></asp:TextBox>
              ...
              Text=" ... " Width="25px" />
                ...
                <asp:TextBox ID="txtCustomerName" CssClass="ControlRequiredStyle" runat="server" Width="213px"></asp:TextBox>
                  ...
                  <tr>
                      ...
                      <td class="ErrorMessageStyle" style="width: 3357px; height: 23px">
                          <asp:DropDownList ID="cboStDay" runat="server" CssClass="ControlRequiredStyle"
                          Width="32%" meta:resourcekey="cboStDayResource1" OnSelectedIndexChanged="cboStDay_SelectedIndexChanged">
                ...
                <tr>
                  ...
                  <td class="auto-style5"><asp:DropDownList ID="cboStDay1" runat="server" CssClass="ControlRequiredStyle"
                  ...
                  </asp:DropDownList><asp:DropDownList ID="cboStMonth1" runat="server" CssClass="ControlRequiredStyle"
                          Width="33%" meta:resourcekey="cboStMonthResource1">
                  ...
                  </asp:DropDownList><asp:DropDownList ID="cboStYear1" runat="server" CssClass="ControlRequiredStyle"
                          Width="32%" meta:resourcekey="cboStYearResource1" style="height: 18px">
                ...
                <tr>
                  <td class="TableLabelStyle" style="height: 20%; width: 15%;">
                      </td>
                  <td style="height: 19px;">
                      &nbsp;</td>
                  <td style="width: 3357px; height: 19px">
                      <asp:CheckBox ID="CheckBox1" runat="server" CssClass="auto-style2" Text="With Credit Approval Transaction" />
                    </td>
                  <td style="width: 3357px; height: 19px">&nbsp;</td>
                </tr>
              </table>
