<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCountrySummeryProductSalesReport.aspx.cs" Inherits="Report_frmCountrySummeryProductSalesReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Country Summery wise Product sales quantity and value</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Sales Quantity and Value
              Country Summery [65]</TD>
        </TR>
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 737px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 181px;">
                    Product Group</TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 181px;">
                    Brand</TD>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 112px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlRequiredStyle" Width="271px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 181px;">
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 112px;">
                    AG</TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="270px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 181px;">
                    Product Code</TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 181px;">
              ...
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 181px;">
                ...
                <TD colSpan="3" style="HEIGHT: 18px">
                    <asp:DropDownList ID="cmbEndDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        meta:resourcekey="cmbStYearResource1" Width="32%">
                        <asp:ListItem meta:resourcekey="ListItemResource46" Selected="True" Value="0">Year</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource47" Value="1999">1999</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource48" Value="2000">2000</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource49" Value="2001">2001</asp:ListItem>
