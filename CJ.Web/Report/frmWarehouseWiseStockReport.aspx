<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmWarehouseWiseStockReport.aspx.cs" Inherits="Report_frmWarehouseWiseStockReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Warehouse wise Logistics Stock Report [293]</title>
  ...
  <body onblur="this.focus">
    <FORM id="Form1" method="post" runat="server">
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 235px;" cellSpacing="0" cellPadding="0"
        width="100%" border="0">
        <TR>
          <TD class="PageTitleStyle">
              Warehouse wise Logistics Stock Report [293]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 783px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 126px;">
                    Product Group</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbProductType" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 31px;"></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 126px;">
                    Brand</TD>
                <TD style="HEIGHT: 14px; width: 1px;"></TD>
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbBrand" tabIndex="40" runat="server" CssClass="ControlRequiredStyle" Width="261px" >
                </asp:dropdownlist></TD>
                <TD style="HEIGHT: 14px; width: 31px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 132px;">
                    Is Active</TD>
                <TD style="HEIGHT: 14px; width: 3px;"></TD>
                <TD style="HEIGHT: 14px; width: 190px;">
                    <asp:DropDownList ID="cmbActive" runat="server" CssClass="ControlRequiredStyle" TabIndex="39"
                        Width="261px">
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 126px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 1px;"></TD>
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlRequiredStyle" Width="261px">
                </asp:dropdownlist></TD>
              ...
              <TR>
                ...
                <tr>
                    <td class="TableLabelStyle" style="width: 126px; height: 8px">
                    AG</td>
                    <td style="width: 1px; height: 8px">
                    </td>
                    <td style="width: 190px; height: 8px">
                        <asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="261px">
                </asp:dropdownlist></td>
                    <td style="width: 31px; height: 8px">
                    </td>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 20px; width: 190px;">
                    <asp:textbox id="txtCode" tabIndex="3" runat="server" CssClass="ControlRequiredStyle" Width="255px"></asp:textbox></TD>
                <TD style="HEIGHT: 20px; width: 31px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 132px;">
                    </TD>
                <TD style="HEIGHT: 20px; width: 3px;"></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 126px;">
                    Description Like</TD>
                <TD style="HEIGHT: 18px; width: 1px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px">
                    <asp:TextBox ID="txtName" runat="server" CssClass="ControlRequiredStyle" Width="255px"></asp:TextBox></TD>
                <TD style="HEIGHT: 18px; width: 3px;"></TD>
