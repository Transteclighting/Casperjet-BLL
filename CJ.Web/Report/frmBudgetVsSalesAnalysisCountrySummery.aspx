<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmBudgetVsSalesAnalysisCountrySummery.aspx.cs" Inherits="Report_frmBudgetVsSalesAnalysisCountrySummery" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Budget Vs Sales Analysis Product Group Wise Country Summery</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
              Budget Vs Sales Analysis Product Category Wise Country Summery [502]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 38px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 839px">
              <TR>
                ...
                <TD style="width: 295px">
                    <asp:DropDownList ID="cboStDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        meta:resourcekey="cboStMonthResource1" Width="31%">
                ...
                <TD style="HEIGHT: 7px; width: 290px;">
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 13px; width: 73px;">
                    </TD>
                <TD style="HEIGHT: 13px; width: 1px;"></TD>
                <TD colSpan="3" style="HEIGHT: 13px">
                    <asp:label id="lblMessage" runat="server" CssClass="ErrorMessageStyle" Width="362px" Visible="False" Height="1px"></asp:label></TD>
                <TD style="HEIGHT: 13px; width: 5px;"></TD>
                <TD align="left" style="HEIGHT: 13px; width: 190px;"></TD>
              </TR>
