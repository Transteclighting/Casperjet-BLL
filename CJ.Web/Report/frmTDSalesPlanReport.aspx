<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTDSalesPlanReport.aspx.cs" Inherits="Report_frmTDSalesPlanReport" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Weekly Sales Plan Report [652]</TD>
        </TR>
        <TR>
            ...
            <TABLE id="Table2" cellSpacing="0" runat="server" cellPadding="0" border="0" style="width: 763px">
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 2604px;">
                    MAG</TD>
                <TD style="HEIGHT: 14px; width: 27px;"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbProductGroup" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
