<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOutstandingPosition.aspx.cs" Inherits="Reports_frmOutstandingPosition" %>
...
<HTML>
  ...
  <body>
    <form id="Form1" method="post" runat="server">
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 100%; height: 53%;">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Customer Outstanding Position Letter [806]</TD>
          </TR>
          <TR>
            <TD class="MenuStyle" title="Pay Sheet" style="width: 910px; height: 29px;">
                &nbsp;<asp:linkbutton id="lnkShowReport" runat="server" CssClass="LinkButtonStyle" onclick="btnShowReport_Click" meta:resourcekey="lnkShowReportResource1">Show Report</asp:linkbutton>&nbsp;</TD>
          </TR>
          <TR>
            ...
            <tr>
                <td style="width: 910px; height: 13px">
                    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="width: 732px">
                        <tr>
                            <td class="TableLabelStyle" style="width: 93px; height: 8px">
                                Channel</td>
                        ...
                        <tr>
                            <td class="TableLabelStyle" style="width: 93px; height: 19px">
                                Area</td>
                        ...
                        <tr>
                            <td class="TableLabelStyle" style="width: 93px; height: 18px">
                                Customer Code</td>
            ...
            <tr>
                <td style="width: 910px; height: 8px">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 295px">                      
                       
                        <tr>
                            <td class="TableLabelStyle" style="width: 3261px; height: 7px">
                            </td>
                            <td style="width: 10404px; height: 7px">
                                </td>
                          
                        </tr>
                        <tr>
                            <td class="TableLabelStyle" style="width: 3261px; height: 8px">
                                To Date:</td>
                            <td style="width: 10404px;   height: 8px">
                                <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                                    Width="29%">
                                ...
                                </asp:DropDownList><asp:DropDownList ID="cbTMonth" runat="server" CssClass="ControlRequiredStyle"
                                ...
                                </asp:DropDownList><asp:DropDownList ID="cbTYear" runat="server" CssClass="ControlRequiredStyle"
          ...
          <TR>
            <TD class="MenuStyle" style="width: 910px; height: 22px;">
                &nbsp;<asp:linkbutton id="lnkShowReportB" runat="server" CssClass="LinkButtonStyle" onclick="btnShowReport_Click" meta:resourcekey="lnkShowReportBResource1">Show Report</asp:linkbutton>&nbsp;</TD>
          </TR>
        </TABLE>
        &nbsp;&nbsp;
