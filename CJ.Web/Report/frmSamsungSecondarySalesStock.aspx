<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSamsungSecondarySalesStock.aspx.cs" Inherits="Report_frmSamsungSecondarySalesStock" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
  <HEAD>
    <title>Secondary sales and Stock quantity</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle" style="height: 24px">
              Samsung Secondary Sales Stock [952]</TD>
        </TR>
        <TR>
          ...
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" runat="server" cellPadding="0" border="0" style="width: 763px">
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbCusttype" tabIndex="44" AutoPostBack="true" runat="server" CssClass="ControlRequiredStyle"  Width="270px">
                </asp:DropDownList></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbASG" tabIndex="44" AutoPostBack="true" runat="server" CssClass="ControlRequiredStyle"  Width="270px">
                </asp:DropDownList></TD>
              </TR>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;">
                    <asp:TextBox ID="txtCustomerName" runat="server" CssClass="ControlRequiredStyle" TabIndex="3"
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbAG" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="270px">
                </asp:DropDownList></TD>
              </TR>
