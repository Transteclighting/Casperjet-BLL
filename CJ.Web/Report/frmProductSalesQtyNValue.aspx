<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmProductSalesQtyNValue.aspx.cs" Inherits="Report_frmProductSalesQtyNValue" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Wise Sales Quantity and Value [146]</TD>
        </TR>
        <TR>
          ...
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" runat="server" cellPadding="0" border="0" style="width: 763px">
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbSupply" tabIndex="39" runat="server" CssClass="ControlRequiredStyle" Width="270px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                ...
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbVatApplicable" tabIndex="38" runat="server" CssClass="ControlRequiredStyle" Width="261px">
              ...
              <TR>
                ...
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="270px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 3147px;">
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 3147px;">
                    Product Code</TD>
                ...
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 2604px;">
                    </TD>
                ...
                <tr>
                    ...
                    <td style="width: 190px; height: 20px">
                        <asp:TextBox ID="txtFromVATChallanNo" runat="server" CssClass="ControlRequiredStyle" TabIndex="3"
              ...
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 3147px;">
                ...
                <tr>
                    ...
                    <td colspan="3" style="height: 18px">
                        <asp:RadioButton ID="rdoVATChallanRange" runat="server" AutoPostBack="True" Checked="True"
                            CssClass="TableLabelStyle" GroupName="Range" 
                            Text="By VAT Challan" Width="195px" /></td>
                ...
                <tr>
                    ...
                    <td colspan="3" style="height: 18px">
                        <asp:RadioButton ID="rdoDateRange" runat="server" AutoPostBack="True" CssClass="TableLabelStyle"
                            GroupName="Range"  Text="By Date Range"
                            Width="195px" /></td>
                    <td style="height: 18px">
                    </td>
                    <td align="left" style="width: 190px; height: 18px">
                ...
                <tr>
                    ...
                    <td colspan="3" style="height: 18px">
                        <asp:RadioButton ID="rdoVATAmount" runat="server" AutoPostBack="True" CssClass="TableLabelStyle"
                            GroupName="Range"  Text="By VAT Amount"
                            Width="195px" /></td>
                            <td style="height: 20px">
                            </td>
                ...
                <TD style="HEIGHT: 7px; width: 648px;">
                    <asp:DropDownList ID="cmbActive" runat="server" CssClass="ControlRequiredStyle" TabIndex="39"
                        Width="259px">
                        <asp:ListItem Value="0.015">0.015</asp:ListItem>
                        <asp:ListItem Value="0.0225">0.0225</asp:ListItem>
