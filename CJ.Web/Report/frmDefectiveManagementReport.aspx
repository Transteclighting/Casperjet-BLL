<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDefectiveManagementReport.aspx.cs" Inherits="Report_frmDefectiveManagementReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Barcode Based Goods Movement Statement</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 235px;" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Barcode Based Goods Movement Statement&nbsp; [613]</TD>
        </TR>
        <tr>
              <td class="MenuStyle" style="height: 10px">
                  <asp:LinkButton ID="LinkButton1" runat="server" CssClass="LinkButtonStyle" Height="14px"
                      meta:resourcekey="lnkShowReportBResource1" OnClick="lnkShowGoodsMovementAll_Click">Show Report</asp:LinkButton>
                  |
          ...
          <TD style="height: 123px">
            ...
            <tr>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbProductType" tabIndex="44" runat="server" OnSelectedIndexChanged="cmbProductType_SelectedIndexChanged" AutoPostBack="True" CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 132px;">
                    WareHouse Location</TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbWarehouseLocation" tabIndex="44" runat="server" OnSelectedIndexChanged="cmbWarehouseLocation_SelectedIndexChanged" AutoPostBack="True" CssClass="ControlStyle"  Width="261px">
                </asp:DropDownList></TD>
              </TR>
              <TR>
                ...
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" OnSelectedIndexChanged="cmbMAG_SelectedIndexChanged" AutoPostBack="True" CssClass="ControlStyle" Width="261px">
                </asp:dropdownlist></TD>
                <TD style="HEIGHT: 14px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 132px;">
                    WareHouse Group</TD>
                <TD style="HEIGHT: 14px;"></TD>
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbWHGroup" tabIndex="44" runat="server" OnSelectedIndexChanged="cmbWHGroup_SelectedIndexChanged" AutoPostBack="True" CssClass="ControlStyle"  Width="261px">
                </asp:DropDownList></TD>
              </TR>
              <TR>
                ...
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbASG" tabIndex="44" runat="server" OnSelectedIndexChanged="cmbASG_SelectedIndexChanged" AutoPostBack="True"  CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                ...
                <TD style="width: 190px; height: 20px;">
                    <asp:dropdownlist id="cmbWareHouse" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                </asp:DropDownList></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 95px;">
                ...
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;">
                    <asp:DropDownList ID="cmbPT" runat="server" CssClass="ControlStyle" Width="261px">
                    </asp:DropDownList></TD>
              </TR>
                <tr>
        ...
        <tr>
              <td class="MenuStyle" style="height: 10px">
                  <asp:LinkButton ID="lnkShowGoodsMovementAll" runat="server" CssClass="LinkButtonStyle" Height="14px"
                      meta:resourcekey="lnkShowReportBResource1" OnClick="lnkShowGoodsMovementAll_Click">Show Report</asp:LinkButton>
                  |
