<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerTransactionTELBLL.aspx.cs" Inherits="Report_frmCustomerTransactionTELBLL" %>
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 97%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Customer Transaction Ledger TELBLL [807]</TD>
          </TR>
          <TR>
          ...
          <TR>
            <TD style="width: 910px">
              ...
              Text=" ... " Width="25px" OnClick="btCustomerSearch_Click" />
                ...
                <tr>
                  ...
                  <td style="width: 3357px; height: 19px"><asp:DropDownList ID="cboStDay1" runat="server" CssClass="ControlRequiredStyle"
