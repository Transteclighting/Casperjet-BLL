<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSalesSummaryChannelWise.aspx.cs" Inherits="Report_frmSalesSummaryChannelWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Sales Summary Channel Wise Report</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Date Range Wise Sales Summery Report Channel Wise [722]</TD>
        </TR>
        <TR>
            ...
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
                <tr>
                    ...
                    <td style="width: 147px; height: 8px">
                        <asp:dropdownlist id="cmbSBU" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                        </asp:DropDownList></td>
                    <td style="width: 1px; height: 8px">
                    </td>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 7px; width: 147px;">
                    <asp:TextBox ID="txtChannelCode" runat="server" CssClass="ControlRequiredStyle" TabIndex="3" Width="258px"></asp:TextBox></TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
