<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmInvoiceWiseOutstandingRegister.aspx.cs" Inherits="Report_frmInvoiceWiseOutstandingRegister" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Invoice Wise Outstanding Register</title>
        ...
        <TABLE id="Table2" cellSpacing="0" runat="server" cellPadding="0" border="0" style="width: 93%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Invoice Wise Outstanding Register [236]</TD>
          </TR>
          <TR>
