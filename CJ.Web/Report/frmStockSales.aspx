<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStockSales.aspx.cs" Inherits="Report_frmStockSales" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <tr>
              <td class="MenuStyle">
                  ...
                  |
                  <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Help/Users.htm" TabIndex="13">Help</asp:HyperLink></td>
         </tr>
