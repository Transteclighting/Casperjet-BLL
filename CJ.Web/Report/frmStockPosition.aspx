<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStockPosition.aspx.cs" Inherits="frmRPTStockPosition" %>
              ...
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 104px;">
                ...
                <tr>
                    ...
                    <asp:DropDownList ID="cmbStDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        Width="21%" TabIndex="9" Visible="False" OnSelectedIndexChanged="cmbStDay_SelectedIndexChanged">
