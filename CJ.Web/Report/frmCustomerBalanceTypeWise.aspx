<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerBalanceTypeWise.aspx.cs" Inherits="Report_frmCustomerBalanceTypeWise" %>
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 97%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px; height: 24px;">
                Customer Outstanding Report [802]</TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <tr>
                <td style="width: 910px; height: 13px">
                    <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 626px; height: 101px;" onclick="return Table2_onclick()">
                        <tr>
                      ...
                      Channel</td>
                            ...
                            <td class="TableLabelStyle" style="width: 69px; height: 8px">
                                Territory</td>
                            <td style="height: 8px;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="TableLabelStyle" style="width: 69px; height: 19px">
                                Customer Type</td>
                            <td style="height: 19px;">
                            </td>
                            <td style="width: 5px; height: 19px"><asp:DropDownList ID="cmbCustType" runat="server" CssClass="ControlStyle" TabIndex="38"
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="height: 18px">
                                <asp:TextBox ID="txtCustomerCode" runat="server" CssClass="ControlStyle" TabIndex="3"
                                    Width="256px" Height="11px"></asp:TextBox></td>
                            <td style="height: 18px;">
                            </td>
                         
                        </tr>
                        <tr>
                            <td class="TableLabelStyle" style="width: 273px; height: 2px">
                                Description Like</td>
                            <td style="width: 9px; height: 2px">
                            </td>
                            <td colspan="3" style="height: 2px">
                                <asp:TextBox ID="txtName" runat="server" CssClass="ControlStyle" TabIndex="3" Width="254px" Height="14px"></asp:TextBox>
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
                                    Height="4px" Text="Type" Width="39px"></asp:Label></td>
                            <td style="height: 2px;">
                            </td>
                            <td align="left" style="width: 5px; height: 2px">
                                &nbsp;<asp:DropDownList ID="cmbType" runat="server" CssClass="ControlStyle" TabIndex="39"
                                    Width="185px" Height="18px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                     <asp:ListItem Selected="True" Value="1">Debit</asp:ListItem>                                   
              ...
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 698px" id="TABLE3" onclick="return TABLE3_onclick()">
                  <tr>
                      <td class="TableLabelStyle" style="width: 3481px; height: 7px">
                          <asp:RadioButton ID="CurrentOutstanding" text="Current Outstanding" runat="server" Width="155px" AutoPostBack="true" OnCheckedChanged="CurrentOutstanding_CheckedChanged" /></td>
          ...
          <TR>
            <TD class="MenuStyle" style="width: 910px">
                &nbsp;<asp:linkbutton id="lnkShowReportB" runat="server" CssClass="LinkButtonStyle" meta:resourcekey="lnkShowReportBResource1" OnClick="lnkShowReportB_Click1" >Show Report</asp:linkbutton>&nbsp;|
