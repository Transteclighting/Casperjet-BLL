<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmGoodsMovementSummeryFinal.aspx.cs" Inherits="Report_frmGoodsMovementSummeryFinal" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 235px;" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Goods Movement Statement&nbsp; [609]</TD>
        </TR>
        <tr>
          ...
          <TD style="height: 123px">
            ...
            <tr>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbWarehouseLocation" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                </asp:DropDownList></TD>
              </TR>
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 132px;">
                    WareHouse</TD>
                <TD style="HEIGHT: 14px;"></TD>
                <TD style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbWareHouse" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                </asp:DropDownList></TD>
              </TR>
              <TR>
