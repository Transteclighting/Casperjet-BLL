<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmYearlyWattageWiseSalesQuantitySBUWise.aspx.cs" Inherits="Report_frmYearlyWattageWiseSalesQuantitySBUWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Yearly Month Wise SKU Report SBU Wise</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
              Yearly Month Wise SKU Report SBU Wise [41]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 667px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 85px;">
                    SBU</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 186px;"><asp:dropdownlist id="cmbSBU" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="242px" OnSelectedIndexChanged="cmbSBU_SelectedIndexChanged">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 92px;">
                    Product Group</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 85px;">
                    Brand</TD>
                <TD style="HEIGHT: 20px; width: 1px;"></TD>
                <TD style="width: 186px; height: 20px;"><asp:dropdownlist id="cmbBrand" tabIndex="40" runat="server" CssClass="ControlStyle" Width="242px">
                </asp:dropdownlist></TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 92px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 1px;"></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 85px;">
                    ASG</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 186px;"><asp:dropdownlist id="cmbASG" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="242px">
                  </asp:dropdownlist></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 85px;">
                    Product Code</TD>
                ...
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 92px;">
                    </TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD style="width: 190px"></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 85px;">
                    Product Like</TD>
