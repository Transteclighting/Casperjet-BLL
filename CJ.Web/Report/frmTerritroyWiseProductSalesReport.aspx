<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTerritroyWiseProductSalesReport.aspx.cs" Inherits="Report_frmTerritroyWiseProductSalesReport" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Product Sales Quantity and Value Territory Wise [62]</TD>
        </TR>
        <TR>
            ...
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              ...
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 14px; width: 70px;">
                    Territory</TD>
                <TD style="HEIGHT: 14px" width="5"></TD>
                <TD style="HEIGHT: 14px; width: 191px;"><asp:dropdownlist id="cmbTerritory" tabIndex="39" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 112px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD style="width: 191px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="275px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 200px;">
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 112px;">
                    AG</TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD style="HEIGHT: 8px; width: 191px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlStyle" Width="275px">
                </asp:dropdownlist></TD>
              </TR>
               <TR>
