<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSalesNpurchaseRegister.aspx.cs" Inherits="Report_frmSalesNpurchaseRegister" %>
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 97%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                VAT Product Stock Statement Report&nbsp;[614]</TD>
          </TR>
          <TR>
          ...
          <TR>
            <TD style="width: 910px; height: 113px;">
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 673px">
                  
                <TR>
                  <TD class="TableLabelStyle" style="width: 15%; height: 24px">
                      ASG</TD>
                  <TD style="height: 24px;"></TD>
                  <TD class="TableLabelStyle" style="height: 24px;" colspan="2">
                      &nbsp;<asp:dropdownlist id="cmbASG" tabIndex=44 runat="server" Width="152px" CssClass="ControlRequiredStyle">
                  </asp:dropdownlist></TD>
                 
                 <TD class="TableLabelStyle" style="width: 15%; height: 24px">
                     VAT</TD>
                  <TD style="height: 24px; width: 32395px;">
                  <asp:dropdownlist id="cmbVAT" tabIndex=44 runat="server" Width="152px" CssClass="ControlRequiredStyle">
                  </asp:dropdownlist></TD>
                  <TD class="TableLabelStyle" style="height: 24px;" colspan="2">
                     &nbsp;&nbsp;&nbsp;
                 ...
                 <TR>
                  ...
                  <TD style="height: 24px;"></TD>
                  <TD class="TableLabelStyle" style="height: 24px;" colspan="2">
                      &nbsp;<asp:TextBox ID="txtProductCode" runat="server" CssClass="ControlRequiredStyle" Width="147px"  AutoPostBack=true  ></asp:TextBox></TD>
              <TD class="TableLabelStyle" style="width: 15%; height: 20%">
                      Product Name</TD>
                  <TD style="height: 24px; width: 32395px;">
                     <asp:TextBox ID="txtProductName" runat="server" CssClass="ControlRequiredStyle" Width="147px"  AutoPostBack=true  ></asp:TextBox></TD>
               <TD class="TableLabelStyle" style="height: 24px;" colspan="2">
                   &nbsp;</TD>
                </TR>
                  ...
                  <tr>
                      ...
                      <td class="ErrorMessageStyle" style="width: 31998px; height: 23px">
                      ...
                      <td class="TableLabelStyle" style="height: 19px; width: 9%;">
                      </td>
                  <td style="height: 19px;">
                      <span style="font-size: 9pt; font-family: Arial"><strong>
                      To Date</strong></span></td>
                  <td style="width: 32395px; height: 19px"><asp:DropDownList ID="cmbStDay1" runat="server" CssClass="ControlRequiredStyle"
