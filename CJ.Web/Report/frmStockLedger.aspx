<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStockLedger.aspx.cs" Inherits="Report_frmStockLedger" %>
...
<HTML>
  ...
  <body onblur="this.focus">
    <FORM id="Form1" method="post" runat="server">
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 271px;" cellSpacing="0" cellPadding="0" runat="server"
        width="100%" border="0">
        <TR>
        ...
        <TR>
          <TD style="height: 96px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 459px; height: 91px;">
                <tr>
                    <td class="TableLabelStyle" style="width: 110px; height: 7px">
                    </td>
                    <td style="width: 1px; height: 7px">
                    </td>
                    <td style="width: 576px; height: 7px">
                        <asp:Label ID="lblCodeError" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            Width="296px"></asp:Label></td>
                </tr>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 110px;">
                    Product Code</TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD style="HEIGHT: 7px; width: 576px;">
                    <asp:TextBox ID="txtProductCode" runat="server" CssClass="ControlStyle" TabIndex="3" Width="98px" AutoPostBack="True" OnTextChanged="txtProductCode_TextChanged"></asp:TextBox>
                    <asp:Button ID="btnEmployees" runat="server" CssClass="ControlButtonStyle" OnClientClick="javascript:window.open('frmProductSearch.aspx','','width=600,height=400,scrollbars=yes,resizable=no,top=150,left=60,status=no,menubar=no,directories=no,location=no,toolbar=no');"
                        Text=" ... " ToolTip="Browse for employee..." />
                    <asp:TextBox ID="txtProductName" runat="server" AutoPostBack="True" CssClass="ControlStyle"
                        OnTextChanged="txtProductCode_TextChanged" TabIndex="3" Width="207px"></asp:TextBox></TD>
              </TR>
                <tr>
                    <td class="TableLabelStyle" style="width: 110px; height: 18px">
                    </td>
                    <td style="width: 1px; height: 18px">
                    </td>
                    <td colspan="1" style="width: 576px; height: 18px">
                        <asp:Label ID="lblErrChannel" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            Width="296px"></asp:Label></td>
                </tr>
                <tr>
                    <td class="TableLabelStyle" style="width: 110px; height: 18px">
                    ...
                    <td colspan="1" style="height: 18px; width: 576px;">
                        <asp:DropDownList ID="cmbChannel" runat="server" AutoPostBack="True" CssClass="ControlStyle"
                             TabIndex="2" Width="283px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td class="TableLabelStyle" style="width: 110px; height: 18px">
                    ...
                    <td colspan="1" style="width: 576px; height: 18px">
                        <asp:Label ID="lblErrWarehouse" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            Width="296px"></asp:Label></td>
                </tr>
                <tr>
                    <td class="TableLabelStyle" style="width: 110px; height: 18px">
                    ...
                    <td colspan="1" style="height: 18px; width: 576px;">
                        <asp:DropDownList ID="cmbWarehouse" runat="server" CssClass="ControlStyle" TabIndex="2"
                            Width="283px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    ...
                    <td colspan="1" style="width: 576px; height: 18px">
                        <asp:Label ID="lblErrFromDate" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            Width="296px"></asp:Label></td>
                </tr>
              <TR>
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 110px;">
                  Date From</TD>
                ...
                <TD colSpan="1" style="HEIGHT: 18px; width: 576px;">
                    <asp:DropDownList ID="cmbStDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        meta:resourcekey="cboStMonthResource1" Width="17%">
              ...
              <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 110px;">
                ...
                <TD colSpan="1" style="HEIGHT: 18px; width: 576px;">
                    <asp:DropDownList ID="cmbEndDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        meta:resourcekey="cboStYearResource1" Width="24%">
                        <asp:ListItem meta:resourcekey="ListItemResource46" Selected="True" Value="0">Year</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource47" Value="1999">1999</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource48" Value="2000">2000</asp:ListItem>
                        <asp:ListItem meta:resourcekey="ListItemResource49" Value="2001">2001</asp:ListItem>
                ...
                <TR>
          <TD style="height: 16px"><asp:label id="lblMessage" runat="server" CssClass="ErrorMessageStyle" Width="386px" Visible="False"></asp:label></TD>
        </TR>
        <tr>
