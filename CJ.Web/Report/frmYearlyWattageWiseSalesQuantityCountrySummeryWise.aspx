<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmYearlyWattageWiseSalesQuantityCountrySummeryWise.aspx.cs" Inherits="Report_frmYearlyWattageWiseSalesQuantityCountrySummeryWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Yearly Month Wise SKU Report National Wise</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
             Yearly Month Wise SKU Report National Wise [40]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 693px">
                ...
                <TD style="width: 613px"><asp:dropdownlist id="cmbProductType" tabIndex="40" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
              ...
              <TR>
                ...
                <TD style="width: 613px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 8px; width: 613px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlStyle" Width="243px">
                </asp:dropdownlist></TD>
