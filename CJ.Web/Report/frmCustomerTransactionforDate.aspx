<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustomerTransactionforDate.aspx.cs" Inherits="Report_frmCustomerTransactionforDate" %>
...
<HTML>
  ...
  <body>
    <form id="Form1" method="post" runat="server">
        ...
        <TABLE id="Table1" cellSpacing="0" cellPadding="0" runat="server" border="0" style="width: 97%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Customer Transaction Register Date Range Wise [805]</TD>
          </TR>
          <TR>
          ...
          <TR>
            <TD style="height: 11px; width: 910px;">
                <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 764px">
                    <tr>
                        <td class="TableLabelStyle" style="width: 127px; height: 8px">
                            Area</td>
                        <td style="height: 8px">
                        </td>
                        <td style="width: 135px; height: 8px">
                            <asp:DropDownList ID="cmbArea" runat="server" CssClass="ControlStyle" TabIndex="44"
                                Width="261px">
                            </asp:DropDownList></td>
                        <td style="height: 8px">
                        </td>
                    ...
                    <tr>
                        <td class="TableLabelStyle" style="width: 127px; height: 19px">
                            Channel</td>
                    ...
                    <tr>
                        <td class="TableLabelStyle" style="width: 127px; height: 18px">
                          Customer Code</td>
          ...
          <TR>
            <TD style="width: 910px">
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 760px">
                  <tr>
                      <td style="width: 1316px; height: 20px">
                      </td>
                      <td style="height: 20px">
                      </td>
                      <td style="width: 5235px; height: 20px">
                          <asp:Label ID="lblTrantype" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                              Height="2px" meta:resourcekey="lblDateErrorResource1" Width="85%"></asp:Label></td>
                      <td class="ErrorMessageStyle" style="width: 5173px; height: 20px">
                      </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1316px; height: 20px">
                          Transaction Type</td>
                      <td style="height: 20px">
                      </td>
                      <td style="width: 5235px; height: 20px">
                          <asp:DropDownList ID="cmbTranType" runat="server" CssClass="ControlStyle"
                          Width="97%" meta:resourcekey="cboStDayResource1">
                          </asp:DropDownList></td>
                      <td class="ErrorMessageStyle" style="width: 5173px; height: 20px">
                      </td>
                  </tr>
                  <tr>
                      ...
                      <td style="width: 5235px; height: 20px">
                          <asp:Label ID="lblTranSide" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                              Height="2px" meta:resourcekey="lblDateErrorResource1" Width="85%"></asp:Label></td>
                      <td class="ErrorMessageStyle" style="width: 5173px; height: 20px">
                      </td>
                  </tr>
                  <tr>
                      ...
                      <td style="width: 5235px; height: 20px"><asp:DropDownList ID="cmbTranSide" runat="server" CssClass="ControlStyle"
                          Width="97%" meta:resourcekey="cboStDayResource1">
                ...
                <tr>
                  <td style="height: 20px; width: 1316px;">
                      </td>
                  <td style="height: 20px;">
                  </td>
                  <td style="width: 5235px; height: 20px">
                      &nbsp;<asp:label id="lblDateError" runat="server" CssClass="ErrorMessageStyle" BorderStyle="None"
                      Width="85%" meta:resourcekey="lblDateErrorResource1" Height="2px"></asp:label></td>                      
                   <td class="ErrorMessageStyle" style="height: 20px; width: 5173px;">
                       <asp:Label ID="DateError" runat="server" BorderStyle="None" CssClass="ErrorMassageStyle"
                           meta:resourcekey="lblDateErrorResource1" Width="97%"></asp:Label></td>
                </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1316px; height: 23px">
                          From Date</td>
                      <td style="height: 23px">
                      </td>
                      <td class="ErrorMessageStyle" style="width: 5235px; height: 23px">
                ...
                <tr>
                  ...
                  <td style="width: 5235px; height: 20px">
                      &nbsp;<asp:Label ID="lblDateError1" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                          meta:resourcekey="lblDateErrorResource1" Width="79%"></asp:Label></td>
                </tr>
                <tr>
                  <td class="TableLabelStyle" style="height: 19px; width: 1316px;">
                      To Date</td>
                  <td style="height: 19px;">
                  </td>
                  <td style="width: 5235px; height: 19px"><asp:DropDownList ID="cmbEndDay" runat="server" CssClass="ControlRequiredStyle"
                          Width="32%" meta:resourcekey="cboStDayResource1">
                  ...
                  <tr>
                      <td class="TableLabelStyle" style="width: 1316px; height: 19px">
                      </td>
                      <td style="height: 19px">
                      </td>
                      <td style="width: 5235px; height: 19px">
                      </td>
                  </tr>
              </table>
