<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmInvoiceRegisterERP.aspx.cs" Inherits="Report_frmInvoiceRegisterERP" %>
...
<HTML>
  ...
  <body>
    <form id="Form1" method="post" runat="server">
        ...
        <TABLE id="Table2" cellSpacing="0" cellPadding="0" runat="server" border="0" style="width: 101%">
          <TR>
            <TD class="PageTitleStyle" style="width: 910px">
                Invoice Register for ERP [92]</TD>
          </TR>
          ...
          <TR>
            <TD style="width: 910px">
              <table cellSpacing="0" cellPadding="0" border="0" style="width: 826px">
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 22px">
                          Get Invoice By</td>
                      <td style="height: 22px">
                      </td>
                      <td style="width: 7327px; height: 22px">
                          <asp:DropDownList ID="cmbInvoiceSearchType" runat="server" Width="223px"  AutoPostBack="True" CssClass="ControlStyle" OnSelectedIndexChanged="cmbInvoiceSearchType_SelectedIndexChanged1">
                              <asp:ListItem Value="6">Invoice ID</asp:ListItem>
                              <asp:ListItem Value="3">Invoice No</asp:ListItem>
                              <asp:ListItem Value="1">Invoice Date</asp:ListItem>
                              <asp:ListItem Value="4">Customer Code</asp:ListItem>
                          </asp:DropDownList></td>
                      <td style="width: 4728px; height: 22px">
                      </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 8px">
                      </td>
                      <td style="height: 8px">
                      </td>
                      <td style="width: 7327px; height: 10%">
                          <asp:Label ID="lblFromDateError" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                          meta:resourcekey="lblDateErrorResource1" Width="38%"></asp:Label></td>
                      <td style="width: 4728px; height: 8px">
                      </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 37px" id="CaptionFrom">
                          <asp:Label ID="lblFrom" runat="server" Text="Label" Width="104px"></asp:Label></td>
                      <td style="height: 37px">
                      </td>
                      <td style="width: 7327px; height: 37px">
                          <asp:TextBox ID="txtFromInvoiceID" runat="server" BorderStyle="Groove" CssClass="ControlRequiredStyle"
                              TabIndex="1" Width="36%" Wrap="False" Visible="False"></asp:TextBox><asp:DropDownList ID="cboStDay"
                                  runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboStDayResource1"
                                  Width="18%">
                                  ...
                                  meta:resourcekey="cboStMonthResource1" Width="15%">
                      ...
                      <td class="TableLabelStyle" style="width: 4728px; height: 37px">
                          </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 19px">
                      </td>
                      <td style="height: 19px">
                      </td>
                      <td style="width: 7327px; height: 19px">
                        <asp:Label ID="lblToDateError" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                            meta:resourcekey="lblDateErrorResource1" Width="38%"></asp:Label></td>
                      <td style="width: 7327px; height: 19px">
                      </td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 8px" id="CaptionTo">
                          <asp:Label ID="lblTo" runat="server" Text="Label" Width="104px"></asp:Label></td>
                      <td style="height: 8px">
                      </td>
                      <td style="width: 7327px; height: 10%">
                          <asp:TextBox ID="txtToInvoiceID" runat="server" BorderStyle="Groove" CssClass="ControlRequiredStyle"
                              TabIndex="1" Width="36%" Wrap="False" Visible="False"></asp:TextBox><asp:DropDownList
                                  ID="cboEndDay" runat="server" CssClass="ControlRequiredStyle" meta:resourcekey="cboEndDayResource1" Width="20%">
                                  <asp:ListItem meta:resourceKey="ListItemResource1" Selected="True" Value="0">Day</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource2" Value="1">01</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource3" Value="2">02</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource4" Value="3">03</asp:ListItem>
                                  ...
                                  meta:resourcekey="cboEndMonthResource1" Width="16%">
                                  <asp:ListItem meta:resourceKey="ListItemResource33" Selected="True" Value="0">Month</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource34" Value="1">Jan</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource35" Value="2">Feb</asp:ListItem>
                                  <asp:ListItem meta:resourceKey="ListItemResource36" Value="3">Mar</asp:ListItem>
                  ...
                  <tr>
                      ...
                      <td style="width: 7327px; height: 10%">
                          <asp:Label ID="lblCustomerCodeErr" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                              meta:resourcekey="lblDateErrorResource1" Width="38%"></asp:Label></td>
                  </tr>
                  <tr>
                      <td class="TableLabelStyle" style="width: 1373px; height: 8px">
                          <asp:Label ID="lblCustomerCode" runat="server" Text="Label" Width="104px"></asp:Label></td>
                      <td style="height: 8px">
                      </td>
                      <td style="width: 7327px; height: 10%">
                          <asp:TextBox ID="txtCustomerCode" runat="server" BorderStyle="Groove" CssClass="ControlRequiredStyle"
                              TabIndex="1" Visible="False" Width="36%" Wrap="False"></asp:TextBox></td>
                  </tr>
              </table>
          ...
          <TR>
            <TD style="height: 19px; width: 910px;">
                <asp:Label ID="lblErrMessage" runat="server" BorderStyle="None" CssClass="ErrorMessageStyle"
                    meta:resourcekey="lblDateErrorResource1" Width="83%"></asp:Label></TD>
          </TR>
          <TR>
            <TD class="MenuStyle" style="width: 910px; height: 22px;">
