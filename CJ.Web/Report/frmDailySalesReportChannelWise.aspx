<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDailySalesReportChannelWise.aspx.cs" Inherits="Report_frmDailySalesReportChannelWise" %>
...
<HTML>
  ...
  <body onblur="this.focus">
    <FORM id="Form1" method="post" runat="server">
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px; height: 153px;" cellSpacing="0" cellPadding="0" runat="server"
        width="100%" border="0">
        <TR>
          <TD class="PageTitleStyle" style="height: 6px">
              Daily Sales Report Channel Wise [701]</TD>
        </TR>
        <TR>
          ...
          <TD style="height: 67px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              ...
              <TR>
                ...
                <TD colSpan="3" style="HEIGHT: 18px"><asp:textbox id="txtName" tabIndex="3" runat="server" CssClass="ControlStyle" Width="255px"></asp:textbox><asp:RadioButton
                        ID="rdoNetSales" runat="server" AutoPostBack="True" Checked="True" CssClass="ControlCheckBoxStyle"
                        Font-Bold="True" GroupName="SalesTypeGroup" Height="8px" 
                        TabIndex="7" Text="Net Sale" Width="129px" /><asp:RadioButton ID="rdoInvoiceSales"
                            runat="server" AutoPostBack="True" CssClass="ControlCheckBoxStyle" Font-Bold="True"
                            GroupName="SalesTypeGroup" Height="8px" 
