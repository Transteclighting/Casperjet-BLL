<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSamsungSalesStock.aspx.cs" Inherits="Report_frmSamsungSalesStock" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
  <head>
   <title>Samsung Product Sales Outlet Wise</title>
        ...
        width="100%" border="0" onclick="return Table1_onclick()">
            <tr>
                <td class="PageTitleStyle" style="width: 910px; height: 24px;">
                    Samsung Product Sales Outlet Wise [950]</td>
            </tr>
            ...
            <tr>
                ...
                <td style="HEIGHT: 14px; width: 190px;"><asp:dropdownlist id="cmbOutlet" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="271px">
                  </asp:dropdownlist></td>
                ...
                <td style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbASG" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="271px">
                  ...
                  <td style="HEIGHT: 20px; width: 2px;"></td>
                        ...
                        <tr>
                            ...
                            <td class="TableLabelStyle" style="width: 3147px; height: 16px">
                                Product Code</td>
