<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOustandingAgeing.aspx.cs" Inherits="Report_frmOustandingAgeing" %>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server"
        ...
        <TR>
          <TD class="PageTitleStyle">
              Outstanding Ageing Report [815]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 725px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 96px;">
                    SBU</TD>
                ...
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbChannel" tabIndex="41" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 96px;">
                    Area</TD>
                <TD style="HEIGHT: 8px; width: 3px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbArea" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 70px;">
                    Territory</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbTerritory" tabIndex="41" runat="server" CssClass="ControlStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>    
                <tr>
                    <td class="TableLabelStyle" style="width: 96px; height: 8px">
                    Customer Type</td>
                    <td style="width: 3px; height: 8px">
                    </td>
                    <td style="width: 147px; height: 8px">
                        <asp:dropdownlist id="cmbCType" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="261px">
                  </asp:dropdownlist></td>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 96px;">
                    Customer Code</TD>
                <TD style="HEIGHT: 7px; width: 3px;"></TD>
                <TD style="HEIGHT: 7px; width: 147px;">
                    <asp:TextBox ID="txtCode" runat="server" CssClass="ControlStyle" TabIndex="3" Width="258px"></asp:TextBox></TD>
              ...
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 96px;">
                    Description Like</TD>
        ...
        <tr>
              <td class="MenuStyle" style="height: 22px">
                  ...
                  <asp:LinkButton ID="lnkShowReportB" runat="server" CssClass="LinkButtonStyle" Height="14px"
                      meta:resourcekey="lnkShowReportBResource1" OnClick="btnShowReport_Click">Customer Wise</asp:LinkButton>
                  |&nbsp;
                  |
