<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmYearlySKUWiseSalesQuantitySBUWise.aspx.cs" Inherits="Report_frmYearlySKUWiseSalesQuantitySBUWise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Yearly Month Wise Sales Quantity SKU Report SBU Wise</title>
      ...
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        ...
        <TR>
          <TD class="PageTitleStyle">
              Yearly Month Wise Sales Quantity SKU Report SBU Wise [56]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 916px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 130px;">
                    SBU</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 243px;"><asp:dropdownlist id="cmbSBU" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="242px" OnSelectedIndexChanged="cmbSBU_SelectedIndexChanged">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 129px;">
                    Product Group</TD>
                <TD style="HEIGHT: 8px"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbProductType" tabIndex="41" runat="server" CssClass="ControlStyle" Width="247px">
                </asp:dropdownlist></TD>
              </TR>
              
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 130px;">
                    Brand</TD>
                <TD style="HEIGHT: 20px; width: 1px;"></TD>
                <TD style="width: 243px; height: 20px;"><asp:dropdownlist id="cmbBrand" tabIndex="40" runat="server" CssClass="ControlStyle" Width="242px">
                </asp:dropdownlist></TD>
                <TD style="HEIGHT: 20px; width: 2px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 129px;">
                    MAG</TD>
                <TD style="HEIGHT: 20px;"></TD>
                <TD style="width: 190px; height: 20px;"><asp:dropdownlist id="cmbMAG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="246px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 130px;">
                    ASG</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 243px;"><asp:dropdownlist id="cmbASG" tabIndex="44" runat="server" CssClass="ControlStyle"  Width="242px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 2px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 129px;">
                    AG</TD>
                <TD style="HEIGHT: 8px;"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbAG" tabIndex="41" runat="server" CssClass="ControlStyle" Width="246px">
                </asp:dropdownlist></TD>
              </TR>
               <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 130px;">
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 129px;">
                    TG Type</TD>
                <TD style="HEIGHT: 20px;"></TD>
                <TD style="width: 648px; height: 20px;"><asp:dropdownlist id="cmbTG" tabIndex="40" runat="server" CssClass="ControlStyle" Width="246px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 130px;">
                    Product Code</TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD style="HEIGHT: 7px; width: 243px;">
                    <asp:textbox id="txtCode" tabIndex="3" runat="server" CssClass="ControlStyle" Width="234px"></asp:textbox></TD>
                <TD style="HEIGHT: 7px; width: 1px;"></TD>
                <TD class="TableLabelStyle" style="HEIGHT: 7px; width: 129px;">
                    </TD>
                <TD style="HEIGHT: 7px"></TD>
                <TD style="width: 190px"></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 130px;">
                    Product Like</TD>
                <TD style="HEIGHT: 18px; width: 1px;"></TD>
                <TD colSpan="3" style="HEIGHT: 18px">
                    <asp:TextBox ID="txtName" runat="server" CssClass="ControlStyle" Width="234px"></asp:TextBox></TD>
