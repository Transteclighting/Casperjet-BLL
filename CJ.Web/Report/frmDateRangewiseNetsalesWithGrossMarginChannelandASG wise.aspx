<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDateRangewiseNetsalesWithGrossMarginChannelandASG wise.aspx.cs" Inherits="Report_frmDateRangewiseNetsalesWithGrossMarginChannelandASG_wise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<HTML>
  <HEAD>
    <title>Product Sales Quantity and Value Channel Wise</title>
  ...
  <body onblur="this.focus">
    <FORM id="Form1" method="post" runat="server">
      <TABLE id="Table1" style="Z-INDEX: 108; LEFT: 8px; TOP: 8px" cellSpacing="0" cellPadding="0" runat="server" 
        width="100%" border="0">
        <TR>
          <TD class="PageTitleStyle" style="height: 9px">
              Date Range Wise Net Sales With Gross Margin Channel &amp; ASG Wise [740]</TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD style="height: 123px">
            <TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0" style="width: 700px">
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 1978px;">
                    SBU</TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
                <TD style="HEIGHT: 8px; width: 147px;"><asp:dropdownlist id="cmbSBU" tabIndex="44" runat="server" CssClass="ControlRequiredStyle"  Width="261px">
                  </asp:dropdownlist></TD>
                <TD style="HEIGHT: 8px; width: 1px;"></TD>
              ...
              <TR>
                ...
                <TD class="TableLabelStyle" style="HEIGHT: 8px; width: 70px;">
                    Brand</TD>
                <TD style="HEIGHT: 8px" width="5"></TD>
                <TD style="HEIGHT: 8px; width: 190px;"><asp:dropdownlist id="cmbBrand" tabIndex="41" runat="server" CssClass="ControlRequiredStyle" Width="274px">
                </asp:dropdownlist></TD>
              </TR>
              <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 20px; width: 1978px;">
                    MAG</TD>
              ...
              <TR>
               ...
               <TR>
                <TD class="TableLabelStyle" style="HEIGHT: 18px; width: 1978px;">
                    </TD>
                ...
                <tr>
                    <td class="TableLabelStyle" style="width: 1978px; height: 18px">
                    </td>
