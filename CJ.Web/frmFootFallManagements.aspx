<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFootFallManagements.aspx.cs" Inherits="frmFootFallManagements" %>
                  ...
                  <tr>                  
                      <td style="height: 90px; width: 1285px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 693px">
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 81px; height: 18px">
                                      From Date</td>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 54px; height: 18px">
                                      <asp:TextBox ID="txtCustomerName" CssClass="ControlRequiredStyle" runat="server" Width="221px"></asp:TextBox></td>
                                      
                                   <td class="TableLabelStyle" style="width: 10px; height: 18px; text-align: right;">
                                     Reason:&nbsp;
                                  </td>
                                <td style="width: 105px; height: 18px">
                                   <asp:DropDownList ID="cmbReason" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="184px">
                                     </asp:DropDownList></td>
                               </tr>  
                               <tr>
                               <td class="TableLabelStyle" style="width: 81px; height: 19px; text-align: left;">
                                     Is Sold?&nbsp;
                                  </td>
                                <td style="width: 54px; height: 19px">
                                   <asp:DropDownList ID="cmbIsSold" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="79px">
                                     </asp:DropDownList></td>
                                     
                                          
                                <td class="TableLabelStyle" style="width: 10px; height: 19px; text-align: right;">
                                    &nbsp;Outlet:&nbsp;</td>
                                <td style="width: 105px; height: 19px">
                                   <asp:DropDownList ID="cmbOutlet" runat="server" AutoPostBack="true" CssClass="ControlStyle" Height="17px"
                                         Width="184px" OnSelectedIndexChanged="cmbOutlet_SelectedIndexChanged" >
                                     </asp:DropDownList></td>
                ...
                <tr>
                    <td style="width: 685px">
                       <asp:GridView ID="dvwFootFallCustomer" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Foot Fall No">
                                <ItemTemplate>
                                   <asp:LinkButton ID="FootFallNo" runat="server"  OnClick="EditItem" Text='<%# DataBinder.Eval (Container.DataItem, "FootFallNo") %>'  Width="100px"></asp:LinkButton>
                                </ItemTemplate>                                
                             ...
                             <asp:TemplateField HeaderText="Create Date">
                                <ItemTemplate>
                                   <asp:Label ID="FootFallDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "FootFallDate") %>' Width="70px"></asp:Label>
                                </ItemTemplate>
                                 <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="Customer Name">
                                <ItemTemplate>
                                   <asp:Label ID="CustomerName" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "CustomerName") %>' Width="120"></asp:Label>
                                </ItemTemplate>
                                   <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Contact No">
                                <ItemTemplate>
                                   <asp:Label ID="ContactNo" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "ContactNo") %>' Width="70px"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>     

                            <asp:TemplateField HeaderText="Is Sold?">
                                <ItemTemplate>
                                   <asp:Label ID="IsSold" runat="server"  Text='<%# DataBinder.Eval (Container.DataItem, "IsSold") %>'  Width="25px"></asp:Label>
                                </ItemTemplate>                                
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>   
                            <asp:TemplateField HeaderText="Reason">
                                <ItemTemplate>
                                   <asp:Label ID="Reason" runat="server"  Text='<%# DataBinder.Eval (Container.DataItem, "Reason") %>'  Width="100px"></asp:Label>
                                </ItemTemplate>                                
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                     
