<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmECOrders.aspx.cs" Inherits="frmECOrders" %>
       ...
       <div>
          ...
          <div>
            <table id="Table3" runat="server" border="0" cellpadding="0" cellspacing="0"
                  style="z-index: 108; left: 8px; top: 8px; ">
                  <tr>
                  ...
                  <tr>                  
                      <td style="width: 959px;">
                          ...
                          <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="width: 706px">
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 100px; height: 18px">
                                      From Date</td>
                    ...
                    <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <table id="Table4" border="0" cellpadding="0" cellspacing="0" style="width: 706px">
                              <tr>
                                  <td class="TableLabelStyle" style="width: 100px; height: 24px">
                                      Order No</td>

                                  <td style="width: 115px; height: 24px">
                                      <asp:TextBox ID="txtOrderNo" runat="server" CssClass="ControlStyle" Width="115px"></asp:TextBox></td>
                                  <td class="TableLabelStyle" style="width: 100px; height: 24px">
                                      &nbsp;Satus</td>
                                 ...
                                 <td class="TableLabelStyle" style="width: 100px; height: 24px">
                                  ...
                                  <td style="width: 150px; height: 24px;">
                                      <asp:DropDownList ID="cbWarehouse" runat="server" CssClass="ControlStyle" TabIndex="40"
                                          Width="192px">
                                      </asp:DropDownList></td>
                              </tr>  
                  ...
                  <tr>
                      <td style="height: 3px; width: 959px;">
                    ...
                    <td>
                        <asp:GridView ID="dvwSalesOrders" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Order Date">
                                <ItemTemplate>
                                   <asp:Label ID="OrderDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "OrderDate") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                          
