<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCustQueryOutlets.aspx.cs" Inherits="frmCustQueryOutlets" %>
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 134px; height: 18px">
                                      <asp:TextBox ID="txtID" CssClass="ControlRequiredStyle" runat="server" Width="139px"></asp:TextBox></td>
                                  <td class="TableLabelStyle" style="width: 156px; height: 18px; text-align: center;">
                                      Name:&nbsp;
                                  </td>
                               
                                  <td style="width: 131px; height: 18px">
                                      <asp:TextBox ID="txtCustomerName" CssClass="ControlRequiredStyle" runat="server" align="Right"  Width="282px"></asp:TextBox></td>
                               </tr>
                               <tr>
                               <td class="TableLabelStyle" style="width: 123px; height: 18px; text-align: left;">
                                     Is Sale:&nbsp;
                                  </td>
                                <td style="width: 134px; height: 18px">
                                   <asp:DropDownList ID="cmbIsSale" runat="server" CssClass="ControlStyle" Height="17px"
                                         Width="174px">
                                     </asp:DropDownList></td> 
                                <td class="TableLabelStyle" style="width: 156px; height: 19px; text-align: center;">
                                      Outlet:&nbsp;
                                  </td>
              ...
              <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 685px">
                ...
                <tr>
                    <td style="width: 685px">
                       <asp:GridView ID="dvwCustomerQuery" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" Width="678px" >
                            <Columns>       
                                                                           
                            <asp:TemplateField HeaderText="Query ID">
                                <ItemTemplate>
                                   <asp:LinkButton ID="QueryID" runat="server"  OnClick="AddSaleExecute" Text='<%# DataBinder.Eval (Container.DataItem, "QueryID") %>'  Width="70px"></asp:LinkButton>
                                </ItemTemplate>                                
                             ...
                             <asp:TemplateField HeaderText="Create Date">
                                <ItemTemplate>
                                   <asp:Label ID="CreateDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "CreateDate") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                 <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="Name">
                                <ItemTemplate>
                                   <asp:Label ID="Name" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Name") %>' Width="150"></asp:Label>
                                </ItemTemplate>
                                   <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Is Sale?">
                                <ItemTemplate>
                                   <asp:Label ID="Status" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "Status") %>' Width="50px"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:TemplateField>  
