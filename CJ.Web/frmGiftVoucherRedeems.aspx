<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmGiftVoucherRedeems.aspx.cs" Inherits="frmGiftVoucherRedeems" %>
                  ...
                  <tr>                  
                    ...
                    <asp:DropDownList ID="cbTDay" runat="server" CssClass="ControlStyle" meta:resourcekey="cboStDayResource1"
                        ...
                        <asp:ListItem meta:resourcekey="ListItemResource78" Value="2030">2030</asp:ListItem>
                              ...
                              <tr>
                                  <td class="TableLabelStyle" style="width: 150px; height: 19px">
                                      SerialNo No</td>
                    ...
                    <td style="width: 800px">
                       <asp:GridView ID="dvwGiftVouchers" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <asp:TemplateField HeaderText="Serial No" HeaderStyle-HorizontalAlign="Left" >
                             ...
                             <asp:TemplateField HeaderText="Redeem Date" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="RedeemDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "RedeemDate") %>' Width="120px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                               <asp:TemplateField HeaderText="Unit Price" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="UnitPrice" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "UnitPrice") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Sold Outlet" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="SoldOutlet" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "SoldOutlet") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                          
                            <asp:TemplateField HeaderText="Sold Date" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                   <asp:Label ID="SoldDate" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "SoldDate") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
