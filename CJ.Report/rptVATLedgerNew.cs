...
namespace CJ.Report {
    ...
    public class rptVATLedgerNew : ReportClass {
        
        public rptVATLedgerNew() {
        }
        
        public override string ResourceName {
            get {
                return "rptVATLedgerNew.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CJ.Report.rptVATLedgerNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptVATLedgerNew : Component, ICachedReport {
        
        public CachedrptVATLedgerNew() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptVATLedgerNew rpt = new rptVATLedgerNew();
            rpt.Site = this.Site;
            return rpt;
        }
