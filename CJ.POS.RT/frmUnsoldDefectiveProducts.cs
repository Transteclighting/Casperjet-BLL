...
namespace CJ.POS.RT
{
    public partial class frmUnsoldDefectiveProducts : Form
    {
        ...
        private void DataLoadControl()
        {
            ...
            _oUnsoldDefectiveProducts.RefreshForPOSRT(dtFromdate.Value.Date, dtTodate.Value.Date, nStatus, txtBarcode.Text.Trim(), IsCheck, txtDefectiveNo.Text.Trim(), txtProductCode.Text.Trim(), txtProductName.Text.Trim(), nStockStatus, cmbDefectiveType.SelectedIndex);
