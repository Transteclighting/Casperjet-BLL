...
namespace CJ.POS.RT
{
    public partial class frmSpecialDiscounts : Form
    {
        ...
        private void frmSpecialDiscounts_Load(object sender, EventArgs e)
        {
            ...
            dFromDate.Value = oTELLib.ServerDateTime().Date;
        ...
        private void DataLoadControl()
        {
            ...
            _oPromoDiscountSpecials.RefreshBySpecialApprovalForPOSRT(isCreateDateRangeChecked, dFromDate.Value.Date, dToDate.Value.Date, txtCustomerName.Text.Trim(), txtApprovedNo.Text, txtConsumer.Text, txtName.Text, nStatus, nType, nSalesType);
