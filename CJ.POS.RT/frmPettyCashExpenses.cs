...
namespace CJ.POS.RT
{
    public partial class frmPettyCashExpenses : Form
    {
        ...
        private void DataLoadControl()
        {
            ...
            _oPettyCashExpenses.RefreshByPettyCashExpenseRT(dtFromDate.Value.Date, dtToDate.Value.Date, nStatus, txtCode.Text.Trim(), IsCheck);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            oPettyCashExpenses.ViewPettyCashExpenseRT(nID, oPettyCashExpense.WarehouseID);
