...
namespace CJ.POS.RT
{
    public partial class frmPOSDashboard : Form
    {
        ...
        private void frmPOSDashboard_Load(object sender, EventArgs e)
        {
            ...
            _oTELLib = new TELLib();
            _dSystemDate = _oTELLib.ServerDateTime().Date;
            int nYear = _dSystemDate.Year;
            int nMonth = _dSystemDate.Month;
        ...
        private void GetValue()
        {
            ...
            _oWeekSales.WeekSalesRT(dFromDate, dToDate, nChannelID, sSalesType, nEmployeeID, 0, 0);
            ...
            _oMonthSales.MonthSalesRT(dFirstDateofYear, dToDate, nChannelID, sSalesType, nEmployeeID, 0, 0);
            ...
            _oMAGSales.MAGSalesRT(dFromDate, dToDate, nChannelID, sSalesType, nEmployeeID, 0);
            ...
            _oBrandSales.BrandSalesRT(dFromDate, dToDate, nChannelID, sSalesType, nEmployeeID, 0);
            ...
            _oSalesEmployee.EmpoyeeSalesRT(dFromDate, dToDate, nChannelID, sSalesType, (int)Dictionary.PlanVersionType.ExecutiveMAGWeekTargetQty, 0, 0);
            ...
            _oLeadEmployee.EmpoyeeSalesLeadRT(dFromDate, dToDate, nChannelID, sSalesType, 0, 0);
            ...
            _oChannelSales.ChannelSalesRT(dFromDate, dToDate, nEmployeeID, 0, 0);
            ...
            _LeadSalesExecuteAmount = _oPOSDashboard.GetLeadInvoiceAmountRT(_dSystemDate);
        ...
        private void OnLoadEvent()
        {
            ...
            _oTELLib = new TELLib();
            string _sToday = "";
            _sToday = ExcludeDecimal(_oTELLib.TakaFormat(_oPOSDashboard.SalesDataRT(_dSystemDate, _dSystemDate.AddDays(1))));

            string _sLastDay = "";
            _sLastDay = ExcludeDecimal(_oTELLib.TakaFormat(_oPOSDashboard.SalesDataRT(_dSystemDate.AddDays(-1), _dSystemDate)));

            string _sMTD = "";
            _sMTD = ExcludeDecimal(_oTELLib.TakaFormat(_oPOSDashboard.SalesDataRT(_oTELLib.FirstDayofMonth(_dSystemDate), _dSystemDate.AddDays(1))));

            string _sLM = "";
            _sLM = ExcludeDecimal(_oTELLib.TakaFormat(_oPOSDashboard.SalesDataRT(_oTELLib.FirstDayofLastMonth(_dSystemDate), _oTELLib.FirstDayofMonth(_dSystemDate))));

            double _YTD = 0;
            _YTD = _oPOSDashboard.SalesDataRT(_oTELLib.FirstDayofThisYear(_dSystemDate), _dSystemDate.AddDays(1));
            string _sYTD = "";
            ...
            _LYYTD = _oPOSDashboard.SalesDataRT(_oTELLib.FirstDayofThisYear(_dSystemDate.AddYears(-1)), _LYDate.AddYears(-1));
            ...
            _MTDTarget = _oPOSDashboard.GetMTDTargetRT(_dSystemDate);
            if (_MTDTarget > 0)
            {
