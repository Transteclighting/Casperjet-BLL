    ...
    public partial class frmSmartWarranty : Form
    {
                ...
                try
                {
                    foreach (DataGridViewRow oItemRow in dgvLineItem.Rows)
                    {
                        if (oItemRow.Index < dgvLineItem.Rows.Count)
                        {
                            ...
                            oExtendedWarranty.WarehouseID = Utility.WarehouseID;
                            ...
                            oExtendedWarranty.IssueDate = oLib.ServerDateTime().Date;
                            ...
                            {
                                oExtendedWarranty.InstrumentDate = oLib.ServerDateTime().Date;
                            }
                            try
                            {
                            ...
                            oExtendedWarranty.CreateDate = oLib.ServerDateTime();
                            oExtendedWarranty.CreateUserID = Utility.UserId;
                            oExtendedWarranty.Add(Utility.ShowroomCode);
        ...
        private void txtRefInvoiceNo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtRefInvoiceNo.Text.Length == 13)
            {
                ...
                TELLib oLib = new TELLib();
                oSalesInvoice.RefreshForRetailInvoiceByNoRT(txtRefInvoiceNo.Text.Trim(), oLib.ServerDateTime().Date);
                ...
                else
                {
                    ...
                    lblShowroomName.Text = Utility.WarehouseName;
        ...
        private void dgvLineItem_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 2)
            {
                ...
                {
                    _dtStartDate = oTELlib.ServerDateTime().Date;
                }
                try
                {
                ...
                {
                    _dtEndDate = oTELlib.ServerDateTime().Date;
                }
                ...
                if (oForm._IsTrue == true)
                {
                    ...
                    else
                    {
                        ...
                        dgvLineItem.Rows[e.RowIndex].Cells[13].Value = oTELlib.ServerDateTime().Date.ToString("dd-MMM-yyyy");
