...
namespace CJ.POS.RT
{
    public partial class frmDMSSalesOrderSearch : Form
    {
        ...
        int _nSalesType = 0;
        int _nWarehouseID = 0;
        public frmDMSSalesOrderSearch(int nSalesType,int nWarehouseID)
        {
            InitializeComponent();
        ...
        private void DataLoadControl()
        {
            ...
            _oDMSSecondarySalesOrders.GetConfirmOrderListRT(txtOrderNo.Text, txtCustomerName.Text, _nSalesType, _nWarehouseID);
