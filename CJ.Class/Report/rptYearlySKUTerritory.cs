...
// Date: Feb 29, 2012
// Time :  11:00 AM
// Description: Yearly Month Wise SKU Wise Territory Wise Sales Summary
...
{
    [Serializable]
    public class rptYearlySKUTerritory
    {
        public int _nSBUID;
    ...
    public class rptYearlySKUTerritorys : CollectionBaseCustom
    {
        public void Add(rptYearlySKUTerritory oYearlySKUTerritory)
        {
            this.List.Add(oYearlySKUTerritory);
        }
        public rptYearlySKUTerritory this[Int32 Index]
        {
            get
            {
                return (rptYearlySKUTerritory)this.List[Index];
            }
            set
            {
                if (!(value.GetType().Equals(typeof(rptYearlySKUTerritory))))
                {
        ...
        public void YearlySKUTerritoryWise(DateTime dbFromDate, DateTime dbToDate, DateTime LYFromDate, DateTime LYToDate, DateTime CYToDate, DateTime LYCumToDate)
        {
            ...
            sQueryStringMaster.Append(",p2.ChannelID,p2.ChannelCode,p2.ChannelDescription as ChannelName    ");
            sQueryStringMaster.Append(",p2.AreaID,p2.AreaCode,p2.AreaName   ");
            sQueryStringMaster.Append(",p2.TerritoryID,p2.TerritoryCode,p2.TerritoryName   ");
            ...
            sQueryStringMaster.Append("p2.SBUID,p2.SBUCode,p2.SBUName  ");
            sQueryStringMaster.Append(",p2.ChannelID,p2.ChannelCode,p2.ChannelDescription    ");
            sQueryStringMaster.Append(",p2.AreaID,p2.AreaCode,p2.AreaName   ");
            sQueryStringMaster.Append(",p2.TerritoryID,p2.TerritoryCode,p2.TerritoryName   ");
            sQueryStringMaster.Append(",P3.PGid,p3.PGCode, p3.PGName   ");
            sQueryStringMaster.Append(",P3.MAGid,p3.MAGCode, p3.MAGName   ");
            ...
            GetDataYearlySKUTerritoryWise(cmd);

        }

        private void GetDataYearlySKUTerritoryWise(OleDbCommand cmd)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    rptYearlySKUTerritory oItem = new rptYearlySKUTerritory();
        ...
        public void FromDataSetForYearlySKUTerritoryWise(DataSet oDS)
        {
            InnerList.Clear();
            try
            {
                ...
                {
                    rptYearlySKUTerritory oYearlySKUTerritory = new rptYearlySKUTerritory();

                    oYearlySKUTerritory.SBUID = Convert.ToInt32(oRow["SBUID"].ToString());
                    oYearlySKUTerritory.SBUCode = "";

                    oYearlySKUTerritory.SBUName = (string)oRow["SBUName"];
                    oYearlySKUTerritory.ChannelId = Convert.ToInt32(oRow["ChannelId"].ToString());

                    oYearlySKUTerritory.ChannelCode = "";
                    oYearlySKUTerritory.ChannelName = (string)oRow["ChannelName"];
                    oYearlySKUTerritory.CustomerId = -1;
                    oYearlySKUTerritory.CustomerCode = "";
                    oYearlySKUTerritory.CustomerName = "";
                    oYearlySKUTerritory.ParentCustomerID = -1;
                    oYearlySKUTerritory.ParentCustomerCode = "";
                    oYearlySKUTerritory.ParentCustomerName = "";
                    oYearlySKUTerritory.CustomerTypeId = -1;
                    oYearlySKUTerritory.CustomerTypeCode = "";
                    oYearlySKUTerritory.CustomerTypeName = "";
                    oYearlySKUTerritory.AreaId = Convert.ToInt32(oRow["AreaId"].ToString());
                    oYearlySKUTerritory.AreaCode = "";
                    oYearlySKUTerritory.AreaName = (string)oRow["AreaName"];

                    oYearlySKUTerritory.TerritoryId = Convert.ToInt32(oRow["TerritoryId"].ToString());
                    oYearlySKUTerritory.TerritoryCode = "";
                    oYearlySKUTerritory.TerritoryName = (string)oRow["TerritoryName"];

                    oYearlySKUTerritory.TGID = -1;
                    oYearlySKUTerritory.TGCode = "";
                    oYearlySKUTerritory.TGName = "";
                    oYearlySKUTerritory.TGPosition = 0;

                    oYearlySKUTerritory.PGID = Convert.ToInt32(oRow["PGID"].ToString());

                    oYearlySKUTerritory.PGCode = (string)oRow["PGCode"];
                    oYearlySKUTerritory.PGName = (string)oRow["PGName"];

                    oYearlySKUTerritory.MAGId = Convert.ToInt32(oRow["MAGId"].ToString());
                    oYearlySKUTerritory.MAGCode = "";
                    oYearlySKUTerritory.MAGName = (string)oRow["MAGName"];
                    oYearlySKUTerritory.ASGId = Convert.ToInt32(oRow["ASGId"].ToString());
                    oYearlySKUTerritory.ASGCode = "";

                    oYearlySKUTerritory.ASGName = (string)oRow["ASGName"];

                    oYearlySKUTerritory.AGID = Convert.ToInt32(oRow["AGID"].ToString());
                    oYearlySKUTerritory.AGCode = "";
                    oYearlySKUTerritory.AGName = (string)oRow["AGName"];

                    oYearlySKUTerritory.ProductID = -1;

                    oYearlySKUTerritory.ProductCode = (string)oRow["ProductCode"];
                    oYearlySKUTerritory.ProductName = (string)oRow["ProductName"];

                    oYearlySKUTerritory.BrandID = Convert.ToInt32(oRow["BrandID"].ToString());
                    oYearlySKUTerritory.BrandCode = "";
                    oYearlySKUTerritory.BrandName = (string)oRow["BrandName"];
                    oYearlySKUTerritory.SubBrandID = -1;
                    oYearlySKUTerritory.SubBrandCode = "";
                    oYearlySKUTerritory.SubBrandName = "";
                    oYearlySKUTerritory.BrandPOS = 0;

                    oYearlySKUTerritory.JanSalesCYR = (double)oRow["JanSalesCYR"];
                    oYearlySKUTerritory.FebSalesCYR = (double)oRow["FebSalesCYR"];
                    oYearlySKUTerritory.MarSalesCYR = (double)oRow["MarSalesCYR"];
                    oYearlySKUTerritory.AprSalesCYR = (double)oRow["AprSalesCYR"];
                    oYearlySKUTerritory.MaySalesCYR = (double)oRow["MaySalesCYR"];
                    oYearlySKUTerritory.JunSalesCYR = (double)oRow["JunSalesCYR"];
                    oYearlySKUTerritory.JulSalesCYR = (double)oRow["JulSalesCYR"];
                    oYearlySKUTerritory.AugSalesCYR = (double)oRow["AugSalesCYR"];
                    oYearlySKUTerritory.SepSalesCYR = (double)oRow["SepSalesCYR"];
                    oYearlySKUTerritory.OctSalesCYR = (double)oRow["OctSalesCYR"];
                    oYearlySKUTerritory.NovSalesCYR = (double)oRow["NovSalesCYR"];
                    oYearlySKUTerritory.DecSalesCYR = (double)oRow["DecSalesCYR"];

                    oYearlySKUTerritory.JanSalesLYR = 0;
                    oYearlySKUTerritory.FebSalesLYR = 0;
                    oYearlySKUTerritory.MarSalesLYR = 0;
                    oYearlySKUTerritory.AprSalesLYR = 0;
                    oYearlySKUTerritory.MaySalesLYR = 0;
                    oYearlySKUTerritory.JunSalesLYR = 0;
                    oYearlySKUTerritory.JunSalesLYR = 0;
                    oYearlySKUTerritory.AugSalesLYR = 0;
                    oYearlySKUTerritory.SepSalesLYR = 0;
                    oYearlySKUTerritory.OctSalesLYR = 0;
                    oYearlySKUTerritory.NovSalesLYR = 0;
                    oYearlySKUTerritory.DecSalesLYR = 0;

                    oYearlySKUTerritory.CumSalesCYR = (double)oRow["CumSalesCYR"];
                    oYearlySKUTerritory.TotalSalesLYR = (double)oRow["TotalSalesLYR"];
                    oYearlySKUTerritory.CumSalesLYR = (double)oRow["CumSalesLYR"];


                    try
                    {
                        oYearlySKUTerritory.ProductCodeInNumber = Convert.ToInt64(oRow["ProductCode"].ToString());
                    }
                    catch
                    {
                        oYearlySKUTerritory.ProductCodeInNumber = 1;
                    }

                    oYearlySKUTerritory.ISActive = Convert.ToInt16(oRow["IsActive"].ToString());

                    oYearlySKUTerritory.YearlyTargetQty = (double)oRow["YearlyTargetQty"];
                    oYearlySKUTerritory.YTDTargetQty = (double)oRow["YTDTargetQty"];

                    InnerList.Add(oYearlySKUTerritory);
                }
