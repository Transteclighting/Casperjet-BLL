...
{
    [Serializable]
    public class rptYearlySKUNational
    {
        public int _nSBUID;
    ...
    public class rptYearlySKUNationals : CollectionBaseCustom
    {
        public void Add(rptYearlySKUNational oYearlySKUNational)
        {
            this.List.Add(oYearlySKUNational);
        }
        public rptYearlySKUNational this[Int32 Index]
        {
            get
            {
                return (rptYearlySKUNational)this.List[Index];
            }
            set
            {
                if (!(value.GetType().Equals(typeof(rptYearlySKUNational))))
                {
        ...
        public void YearlySKUNationalWise(DateTime dbFromDate, DateTime dbToDate,DateTime LYFromDate, DateTime LYToDate, DateTime CYToDate, DateTime LYCumToDate)
        {
            ...
            GetDataYearlySKUNationalWise(cmd);

        }

        private void GetDataYearlySKUNationalWise(OleDbCommand cmd)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    rptYearlySKUNational oItem = new rptYearlySKUNational();
        ...
        public void FromDataSetForYearlySKUNationalWise(DataSet oDS)
        {
            InnerList.Clear();
            try
            {
                ...
                {
                    rptYearlySKUNational oYearlySKUNational = new rptYearlySKUNational();

                    oYearlySKUNational.SBUID = -1;
                    oYearlySKUNational.SBUCode = "";
                    oYearlySKUNational.SBUName = "";
                    oYearlySKUNational.ChannelId = -1;
                    oYearlySKUNational.ChannelCode = "";
                    oYearlySKUNational.ChannelName = "";
                    oYearlySKUNational.CustomerId = -1;
                    oYearlySKUNational.CustomerCode = "";
                    oYearlySKUNational.CustomerName = "";
                    oYearlySKUNational.ParentCustomerID = -1;
                    oYearlySKUNational.ParentCustomerCode = "";
                    oYearlySKUNational.ParentCustomerName = "";
                    oYearlySKUNational.CustomerTypeId = -1;
                    oYearlySKUNational.CustomerTypeCode = "";
                    oYearlySKUNational.CustomerTypeName = "";
                    oYearlySKUNational.AreaId = -1;
                    oYearlySKUNational.AreaCode = "";
                    oYearlySKUNational.AreaName = "";
                    oYearlySKUNational.TerritoryId = -1;
                    oYearlySKUNational.TerritoryCode = "";
                    oYearlySKUNational.TerritoryName = "";
                    oYearlySKUNational.TGID = -1;
                    oYearlySKUNational.TGCode = "";
                    oYearlySKUNational.TGName = "";
                    oYearlySKUNational.TGPosition = 0;

                    oYearlySKUNational.PGID = Convert.ToInt32(oRow["PGID"].ToString());

                    oYearlySKUNational.PGCode = (string)oRow["PGCode"];
                    oYearlySKUNational.PGName = (string)oRow["PGName"];

                    oYearlySKUNational.MAGId = Convert.ToInt32(oRow["MAGId"].ToString());
                    oYearlySKUNational.MAGCode = "";
                    oYearlySKUNational.MAGName = (string)oRow["MAGName"];
                    oYearlySKUNational.ASGId = Convert.ToInt32(oRow["ASGId"].ToString());
                    oYearlySKUNational.ASGCode = "";

                    oYearlySKUNational.ASGName = (string)oRow["ASGName"];

                    oYearlySKUNational.AGID = Convert.ToInt32(oRow["AGID"].ToString());
                    oYearlySKUNational.AGCode = "";
                    oYearlySKUNational.AGName = "";

                    oYearlySKUNational.ProductID = -1;

                    oYearlySKUNational.ProductCode = (string)oRow["ProductCode"];
                    oYearlySKUNational.ProductName = (string)oRow["ProductName"];

                    oYearlySKUNational.BrandID = Convert.ToInt32(oRow["BrandID"].ToString());
                    oYearlySKUNational.BrandCode = "";
                    oYearlySKUNational.BrandName = (string)oRow["BrandName"];
                    oYearlySKUNational.SubBrandID = -1;
                    oYearlySKUNational.SubBrandCode = "";
                    oYearlySKUNational.SubBrandName = "";
                    oYearlySKUNational.BrandPOS = 0;

                    oYearlySKUNational.JanSalesCYR = (double)oRow["JanSalesCYR"];
                    oYearlySKUNational.FebSalesCYR = (double)oRow["FebSalesCYR"];
                    oYearlySKUNational.MarSalesCYR = (double)oRow["MarSalesCYR"];
                    oYearlySKUNational.AprSalesCYR = (double)oRow["AprSalesCYR"];
                    oYearlySKUNational.MaySalesCYR = (double)oRow["MaySalesCYR"];
                    oYearlySKUNational.JunSalesCYR = (double)oRow["JunSalesCYR"];
                    oYearlySKUNational.JulSalesCYR = (double)oRow["JulSalesCYR"];
                    oYearlySKUNational.AugSalesCYR = (double)oRow["AugSalesCYR"];
                    oYearlySKUNational.SepSalesCYR = (double)oRow["SepSalesCYR"];
                    oYearlySKUNational.OctSalesCYR = (double)oRow["OctSalesCYR"];
                    oYearlySKUNational.NovSalesCYR = (double)oRow["NovSalesCYR"];
                    oYearlySKUNational.DecSalesCYR = (double)oRow["DecSalesCYR"];

                    oYearlySKUNational.JanSalesLYR = 0;
                    oYearlySKUNational.FebSalesLYR = 0;
                    oYearlySKUNational.MarSalesLYR = 0;
                    oYearlySKUNational.AprSalesLYR = 0;
                    oYearlySKUNational.MaySalesLYR = 0;
                    oYearlySKUNational.JunSalesLYR = 0;
                    oYearlySKUNational.JunSalesLYR = 0;
                    oYearlySKUNational.AugSalesLYR = 0;
                    oYearlySKUNational.SepSalesLYR = 0;
                    oYearlySKUNational.OctSalesLYR = 0;
                    oYearlySKUNational.NovSalesLYR = 0;
                    oYearlySKUNational.DecSalesLYR = 0;

                    oYearlySKUNational.CumSalesCYR = (double)oRow["CumSalesCYR"];
                    oYearlySKUNational.TotalSalesLYR = (double)oRow["TotalSalesLYR"];
                    oYearlySKUNational.CumSalesLYR = (double)oRow["CumSalesLYR"];


                    try
                    {
                        oYearlySKUNational.ProductCodeInNumber = Convert.ToInt64(oRow["ProductCode"].ToString());
                    }
                    catch
                    {
                        oYearlySKUNational.ProductCodeInNumber = 1;
                    }

                    oYearlySKUNational.ISActive = Convert.ToInt16(oRow["IsActive"].ToString());

                    oYearlySKUNational.YearlyTargetQty = (double)oRow["YearlyTargetQty"];
                    oYearlySKUNational.YTDTargetQty = (double)oRow["YTDTargetQty"];


                    oYearlySKUNational.PTGSTID = -1;
                    oYearlySKUNational.PTGSTName = "";
                    oYearlySKUNational.PTGSTPosition = 0;

                    InnerList.Add(oYearlySKUNational);
                }
