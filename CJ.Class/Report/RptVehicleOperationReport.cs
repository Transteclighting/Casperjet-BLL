...
{
    public class RptVehicleOperationReport
    {
    ...
    public class RptVehicleOperationDetails : CollectionBaseCustom
    {
        public void Add(RptVehicleOperationReport oRptVehicleOperationReport)
        {
            this.List.Add(oRptVehicleOperationReport);
        }
        public RptVehicleOperationReport this[Int32 Index]
        {
            get
            {
                return (RptVehicleOperationReport)this.List[Index];
            }
            set
            {
                if (!(value.GetType().Equals(typeof(RptVehicleOperationReport))))
                {
        ...
        public void VehicleOperation(DateTime dYFromDate, DateTime dYToDate, int nCompanyID, int nDepartmentID, string sVehCode)
        {
            InnerList.Clear();
            ...
            sQueryStringMaster.Append("  final.ExpenseHeadName, final.Qty, final.UnitPrice, final.Amount, final.PaymentType, final.Remarks, final.EndReading, final.TripC,final.TripS,final.TripU ");
            ...
            sQueryStringMaster.Append(" F1.ExpenseHeadName, F1.Qty, F1.UnitPrice, F1.Amount, F1.PaymentType, F1.Remarks, F1.EndReading, F1.TripC,F1.TripS,F1.TripU  ");
            sQueryStringMaster.Append(" from ");
            sQueryStringMaster.Append(" ( ");
            ...
            sQueryStringMaster.Append(" q2.ExpenseHeadName, q2.Qty, q2.UnitPrice, q2.Amount, q2.PaymentType, q2.Remarks, VOP.EndReading, VOP.TripC,VOP.TripS,VOP.TripU  ");
            sQueryStringMaster.Append(" from  ");
            sQueryStringMaster.Append(" ( ");
            ...
            sQueryStringMaster.Append(" from t_vehicleOperation a, t_Vehicle b ");
            ...
            sQueryStringMaster.Append(" from t_VehicleExpenseDetails a, t_VehicleExpenseHead b ");
        ...
        public void GetVehicleOperation(OleDbCommand cmd)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    RptVehicleOperationReport oItem = new RptVehicleOperationReport();
        ...
        public void FromDataSetVehicleOperation(DataSet oDS)
        {
            ...
            try
            {
                ...
                {
                    RptVehicleOperationReport oRptVehicleOperationReport = new RptVehicleOperationReport();

                    oRptVehicleOperationReport.DepartmentID = Convert.ToInt32(oRow["DepartmentID"]);
                    oRptVehicleOperationReport.DepartmentName = (string)oRow["DepartmentName"];
                    oRptVehicleOperationReport.CompanyID = Convert.ToInt32(oRow["CompanyID"]);
                    oRptVehicleOperationReport.CompanyName = (string)oRow["CompanyName"];
                    oRptVehicleOperationReport.vehicleOperationID = Convert.ToInt32(oRow["vehicleOperationID"]);
                    oRptVehicleOperationReport.VehicleID = Convert.ToInt32(oRow["VehicleID"]);
                    oRptVehicleOperationReport.VehicleName = (string)oRow["VehicleName"];
                    oRptVehicleOperationReport.RegistrationNo = (string)oRow["RegistrationNo"];
                    oRptVehicleOperationReport.TranDate = Convert.ToDateTime(oRow["TranDate"]);
                    oRptVehicleOperationReport.KMRun = Convert.ToDouble(oRow["KMRun"]);
                    oRptVehicleOperationReport.ExpenseHeadName = (string)oRow["ExpenseHeadName"];
                    oRptVehicleOperationReport.Qty = Convert.ToDouble(oRow["Qty"]);
                    oRptVehicleOperationReport.UnitPrice = Convert.ToDouble(oRow["UnitPrice"]);
                    oRptVehicleOperationReport.Amount = Convert.ToDouble(oRow["Amount"]);
                    oRptVehicleOperationReport.PaymentType = Convert.ToInt32(oRow["PaymentType"]);
                    oRptVehicleOperationReport.Remarks = (string)oRow["Remarks"];
                    oRptVehicleOperationReport.EndReading = Convert.ToDouble(oRow["EndReading"]);
                    oRptVehicleOperationReport.TripC = Convert.ToInt32(oRow["TripC"]);
                    oRptVehicleOperationReport.TripS = Convert.ToInt32(oRow["TripS"]);
                    oRptVehicleOperationReport.TripU = Convert.ToInt32(oRow["TripU"]);
                    InnerList.Add(oRptVehicleOperationReport);
