...
// Date: Mar 07, 2012
// Time :  11:00 AM
// Description: Yearly Month Wise SKU Wise Area Wise Sales Summary
...
namespace CJ.Class.Report
{
    ...
    public class rptYearlySKUAreas : CollectionBaseCustom
    {
        public void Add(rptYearlySKUArea oYearlySKUArea)
        {
            this.List.Add(oYearlySKUArea);
        }
        public rptYearlySKUArea this[Int32 Index]
        {
            get
            {
                return (rptYearlySKUArea)this.List[Index];
            }
            set
            {
                if (!(value.GetType().Equals(typeof(rptYearlySKUArea))))
                {
        ...
        public void YearlySKUAreaWise(DateTime dbFromDate, DateTime dbToDate, DateTime LYFromDate, DateTime LYToDate, DateTime CYToDate, DateTime LYCumToDate)
        {
            ...
            GetDataYearlySKUAreaWise(cmd);

        }

        private void GetDataYearlySKUAreaWise(OleDbCommand cmd)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    rptYearlySKUArea oItem = new rptYearlySKUArea();
        ...
        public void FromDataSetForYearlySKUAreaWise(DataSet oDS)
        {
            InnerList.Clear();
            try
            {
                ...
                {
                    rptYearlySKUArea oYearlySKUArea = new rptYearlySKUArea();

                    oYearlySKUArea.SBUID = Convert.ToInt32(oRow["SBUID"].ToString());
                    oYearlySKUArea.SBUCode = "";

                    oYearlySKUArea.SBUName = (string)oRow["SBUName"];
                    oYearlySKUArea.ChannelId = Convert.ToInt32(oRow["ChannelId"].ToString());

                    oYearlySKUArea.ChannelCode = "";
                    oYearlySKUArea.ChannelName = (string)oRow["ChannelName"];
                    oYearlySKUArea.CustomerId = -1;
                    oYearlySKUArea.CustomerCode = "";
                    oYearlySKUArea.CustomerName = "";
                    oYearlySKUArea.ParentCustomerID = -1;
                    oYearlySKUArea.ParentCustomerCode = "";
                    oYearlySKUArea.ParentCustomerName = "";
                    oYearlySKUArea.CustomerTypeId = -1;
                    oYearlySKUArea.CustomerTypeCode = "";
                    oYearlySKUArea.CustomerTypeName = "";
                    oYearlySKUArea.AreaId = Convert.ToInt32(oRow["AreaId"].ToString());
                    oYearlySKUArea.AreaCode = "";
                    oYearlySKUArea.AreaName = (string)oRow["AreaName"];

                    oYearlySKUArea.TerritoryId = -1;
                    oYearlySKUArea.TerritoryCode = "";
                    oYearlySKUArea.TerritoryName = "";

                    oYearlySKUArea.TGID = -1;
                    oYearlySKUArea.TGCode = "";
                    oYearlySKUArea.TGName = "";
                    oYearlySKUArea.TGPosition = 0;

                    oYearlySKUArea.PGID = Convert.ToInt32(oRow["PGID"].ToString());

                    oYearlySKUArea.PGCode = (string)oRow["PGCode"];
                    oYearlySKUArea.PGName = (string)oRow["PGName"];

                    oYearlySKUArea.MAGId = Convert.ToInt32(oRow["MAGId"].ToString());
                    oYearlySKUArea.MAGCode = "";
                    oYearlySKUArea.MAGName = (string)oRow["MAGName"];
                    oYearlySKUArea.ASGId = Convert.ToInt32(oRow["ASGId"].ToString());
                    oYearlySKUArea.ASGCode = "";

                    oYearlySKUArea.ASGName = (string)oRow["ASGName"];

                    oYearlySKUArea.AGID = Convert.ToInt32(oRow["AGID"].ToString());
                    oYearlySKUArea.AGCode = "";
                    oYearlySKUArea.AGName = (string)oRow["AGName"];

                    oYearlySKUArea.ProductID = -1;

                    oYearlySKUArea.ProductCode = (string)oRow["ProductCode"];
                    oYearlySKUArea.ProductName = (string)oRow["ProductName"];

                    oYearlySKUArea.BrandID = Convert.ToInt32(oRow["BrandID"].ToString());
                    oYearlySKUArea.BrandCode = "";
                    oYearlySKUArea.BrandName = (string)oRow["BrandName"];
                    oYearlySKUArea.SubBrandID = -1;
                    oYearlySKUArea.SubBrandCode = "";
                    oYearlySKUArea.SubBrandName = "";
                    oYearlySKUArea.BrandPOS = 0;

                    oYearlySKUArea.JanSalesCYR = (double)oRow["JanSalesCYR"];
                    oYearlySKUArea.FebSalesCYR = (double)oRow["FebSalesCYR"];
                    oYearlySKUArea.MarSalesCYR = (double)oRow["MarSalesCYR"];
                    oYearlySKUArea.AprSalesCYR = (double)oRow["AprSalesCYR"];
                    oYearlySKUArea.MaySalesCYR = (double)oRow["MaySalesCYR"];
                    oYearlySKUArea.JunSalesCYR = (double)oRow["JunSalesCYR"];
                    oYearlySKUArea.JulSalesCYR = (double)oRow["JulSalesCYR"];
                    oYearlySKUArea.AugSalesCYR = (double)oRow["AugSalesCYR"];
                    oYearlySKUArea.SepSalesCYR = (double)oRow["SepSalesCYR"];
                    oYearlySKUArea.OctSalesCYR = (double)oRow["OctSalesCYR"];
                    oYearlySKUArea.NovSalesCYR = (double)oRow["NovSalesCYR"];
                    oYearlySKUArea.DecSalesCYR = (double)oRow["DecSalesCYR"];

                    oYearlySKUArea.JanSalesLYR = 0;
                    oYearlySKUArea.FebSalesLYR = 0;
                    oYearlySKUArea.MarSalesLYR = 0;
                    oYearlySKUArea.AprSalesLYR = 0;
                    oYearlySKUArea.MaySalesLYR = 0;
                    oYearlySKUArea.JunSalesLYR = 0;
                    oYearlySKUArea.JunSalesLYR = 0;
                    oYearlySKUArea.AugSalesLYR = 0;
                    oYearlySKUArea.SepSalesLYR = 0;
                    oYearlySKUArea.OctSalesLYR = 0;
                    oYearlySKUArea.NovSalesLYR = 0;
                    oYearlySKUArea.DecSalesLYR = 0;

                    oYearlySKUArea.CumSalesCYR = (double)oRow["CumSalesCYR"];
                    oYearlySKUArea.TotalSalesLYR = (double)oRow["TotalSalesLYR"];
                    oYearlySKUArea.CumSalesLYR = (double)oRow["CumSalesLYR"];


                    try
                    {
                        oYearlySKUArea.ProductCodeInNumber = Convert.ToInt64(oRow["ProductCode"].ToString());
                    }
                    catch
                    {
                        oYearlySKUArea.ProductCodeInNumber = 1;
                    }

                    oYearlySKUArea.ISActive = Convert.ToInt16(oRow["IsActive"].ToString());

                    oYearlySKUArea.YearlyTargetQty = (double)oRow["YearlyTargetQty"];
                    oYearlySKUArea.YTDTargetQty = (double)oRow["YTDTargetQty"];


                    oYearlySKUArea.PTGSTID = -1;
                    oYearlySKUArea.PTGSTName = "";
                    oYearlySKUArea.PTGSTPosition = 0;

                    oYearlySKUArea.PTGTID = -1;
                    oYearlySKUArea.PTGTName = "";
                    oYearlySKUArea.PTGTPosition = 0;

                    InnerList.Add(oYearlySKUArea);
                }
