...
namespace CJ.Class.Library
{
    public class TELLib
    {
        ...
        public DateTime FirstDayofNextMonth(DateTime _Date)
        {
            //Written by Shavagata Saha
            DateTime Month = new DateTime(_Date.Year, _Date.Month, 1);
            DateTime dDate = Month.AddMonths(1);
            return dDate;
        }

        public DateTime FirstDayofNextMonthLastYear(DateTime _Date)
        {
            //Written by Shavagata Saha
            DateTime Month = new DateTime(_Date.Year, _Date.Month, 1);
            DateTime dDate = Month.AddMonths(1);
        ...
        public string TakaFormatWithoutDesimal(double _Number)
        {
            //Written by Shaila
            string _sign = "";
            string _NumStr;
        ...
        public string ExcludeDecimal(string sAmount)
        {
            //Written by Hakim
            string sResult = "";
        ...
        public DateTime ServerDateTime()
        {
            ...
            string sSql = " Select getdate() as CurrentDate ";
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    _date = (DateTime)reader["CurrentDate"];
                }
            }
            catch (Exception ex)
            {
