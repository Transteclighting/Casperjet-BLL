...
// Time :  10:30 AM
// Description: Class for Month Wise Area Wise Target vs Ach.
...
{
    public class rptMonthAreaTargetvsAch
    {
    ...
    public class rptMonthAreaTargetvsAchs : CollectionBase
    {

        public rptMonthAreaTargetvsAch this[int i]
        {
            get { return (rptMonthAreaTargetvsAch)InnerList[i]; }
            set { InnerList[i] = value; }
        }
        public void Add(rptMonthAreaTargetvsAch oAreaWiseQty)
        {
            InnerList.Add(oAreaWiseQty);
        }

        public void AreaWiseSalesvsTargetAll(DateTime dbFromDate, DateTime dbTODate, DateTime dCYFromDate, DateTime dCYToDate)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (Convert.ToInt32(reader["JanSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["FebSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["MarSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["AprSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["MaySalesQty"].ToString()) > 0 || Convert.ToInt32(reader["JunSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["JulSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["AugSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["SepSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["OctSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["NovSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["DecSalesQty"].ToString()) > 0 || Convert.ToInt32(reader["JanTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["FebTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["MarTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["AprTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["MayTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["JunTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["JulTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["AugTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["SepTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["OctTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["NovTargetQty"].ToString()) > 0 || Convert.ToInt32(reader["DecTargetQty"].ToString()) > 0)
                    {
                        ...
                        oAreaWiseQty.AreaName = (string)reader["AreaName"];
                        oAreaWiseQty.JanSalesQty = Convert.ToInt32(reader["JanSalesQty"].ToString());
                        oAreaWiseQty.FebSalesQty = Convert.ToInt32(reader["FebSalesQty"].ToString());
                        oAreaWiseQty.MarSalesQty = Convert.ToInt32(reader["MarSalesQty"].ToString());
                        oAreaWiseQty.AprSalesQty = Convert.ToInt32(reader["AprSalesQty"].ToString());
                        oAreaWiseQty.MaySalesQty = Convert.ToInt32(reader["MaySalesQty"].ToString());
                        oAreaWiseQty.JunSalesQty = Convert.ToInt32(reader["JunSalesQty"].ToString());
                        oAreaWiseQty.JulSalesQty = Convert.ToInt32(reader["JulSalesQty"].ToString());
                        oAreaWiseQty.AugSalesQty = Convert.ToInt32(reader["AugSalesQty"].ToString());
                        oAreaWiseQty.SepSalesQty = Convert.ToInt32(reader["SepSalesQty"].ToString());
                        oAreaWiseQty.OctSalesQty = Convert.ToInt32(reader["OctSalesQty"].ToString());
                        oAreaWiseQty.NovSalesQty = Convert.ToInt32(reader["NovSalesQty"].ToString());
                        oAreaWiseQty.DecSalesQty = Convert.ToInt32(reader["DecSalesQty"].ToString());
                        oAreaWiseQty.TotalSalesQty = oAreaWiseQty.JanSalesQty + oAreaWiseQty.FebSalesQty + oAreaWiseQty.MarSalesQty + oAreaWiseQty.AprSalesQty + oAreaWiseQty.MaySalesQty + oAreaWiseQty.JunSalesQty + oAreaWiseQty.JulSalesQty + oAreaWiseQty.AugSalesQty + oAreaWiseQty.SepSalesQty + oAreaWiseQty.OctSalesQty + oAreaWiseQty.NovSalesQty + oAreaWiseQty.DecSalesQty;
                        oAreaWiseQty.JanTargetQty = (double)reader["JanTargetQty"];
                        oAreaWiseQty.FebTargetQty = (double)reader["FebTargetQty"];
                        oAreaWiseQty.MarTargetQty = (double)reader["MarTargetQty"];
                        oAreaWiseQty.AprTargetQty = (double)reader["AprTargetQty"];
                        oAreaWiseQty.MayTargetQty = (double)reader["MayTargetQty"];
                        oAreaWiseQty.JunTargetQty = (double)reader["JunTargetQty"];
                        oAreaWiseQty.JulTargetQty = (double)reader["JulTargetQty"];
                        oAreaWiseQty.AugTargetQty = (double)reader["AugTargetQty"];
                        oAreaWiseQty.SepTargetQty = (double)reader["SepTargetQty"];
                        oAreaWiseQty.OctTargetQty = (double)reader["OctTargetQty"];
                        oAreaWiseQty.NovTargetQty = (double)reader["NovTargetQty"];
                        oAreaWiseQty.DecTargetQty = (double)reader["DecTargetQty"];
                        oAreaWiseQty.TotalTargetQty = oAreaWiseQty.JanTargetQty + oAreaWiseQty.FebTargetQty + oAreaWiseQty.MarTargetQty + oAreaWiseQty.AprTargetQty + oAreaWiseQty.MayTargetQty + oAreaWiseQty.JunTargetQty + oAreaWiseQty.JulTargetQty + oAreaWiseQty.AugTargetQty + oAreaWiseQty.SepTargetQty + oAreaWiseQty.OctTargetQty + oAreaWiseQty.NovTargetQty + oAreaWiseQty.DecTargetQty;

                        oAreaWiseQty.JanAch = ((oAreaWiseQty.JanSalesQty) / (oAreaWiseQty.JanTargetQty)) * 100;
                        oAreaWiseQty.FebAch = ((oAreaWiseQty.FebSalesQty) / (oAreaWiseQty.FebTargetQty)) * 100;
                        oAreaWiseQty.MarAch = ((oAreaWiseQty.MarSalesQty) / (oAreaWiseQty.MarTargetQty)) * 100;
                        oAreaWiseQty.AprAch = ((oAreaWiseQty.AprSalesQty) / (oAreaWiseQty.AprTargetQty)) * 100;
                        oAreaWiseQty.MayAch = ((oAreaWiseQty.MaySalesQty) / (oAreaWiseQty.MayTargetQty)) * 100;
                        oAreaWiseQty.JunAch = ((oAreaWiseQty.JunSalesQty) / (oAreaWiseQty.JunTargetQty)) * 100;
                        oAreaWiseQty.JulAch = ((oAreaWiseQty.JulSalesQty) / (oAreaWiseQty.JulTargetQty)) * 100;
                        oAreaWiseQty.AugAch = ((oAreaWiseQty.AugSalesQty) / (oAreaWiseQty.AugTargetQty)) * 100;
                        oAreaWiseQty.SepAch = ((oAreaWiseQty.SepSalesQty) / (oAreaWiseQty.SepTargetQty)) * 100;
                        oAreaWiseQty.OctAch = ((oAreaWiseQty.OctSalesQty) / (oAreaWiseQty.OctTargetQty)) * 100;
                        oAreaWiseQty.NovAch = ((oAreaWiseQty.NovSalesQty) / (oAreaWiseQty.NovTargetQty)) * 100;
                        oAreaWiseQty.DecAch = ((oAreaWiseQty.DecSalesQty) / (oAreaWiseQty.DecTargetQty)) * 100;
                        oAreaWiseQty.TotalAch = ((oAreaWiseQty.TotalSalesQty) / (oAreaWiseQty.TotalTargetQty)) * 100;
        ...
        public void AreaWiseSalesvsTargetASG(DateTime dbFromDate, DateTime dbTODate, DateTime dCYFromDate, DateTime dCYToDate, string sASG)
        {
            dbTODate = dbTODate.AddDays(1);
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
        ...
        public void AreaWiseSalesvsTargetBrand(DateTime dbFromDate, DateTime dbTODate, DateTime dCYFromDate, DateTime dCYToDate, string sBrand)
        {
            dbTODate = dbTODate.AddDays(1);
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
        ...
        public void AreaWiseSalesvsTargetBrandASG(DateTime dbFromDate, DateTime dbTODate, DateTime dCYFromDate, DateTime dCYToDate, string sBrand, string sASG)
        {
            dbTODate = dbTODate.AddDays(1);
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
