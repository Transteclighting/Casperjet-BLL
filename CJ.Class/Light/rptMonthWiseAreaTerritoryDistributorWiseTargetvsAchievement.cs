...
// Time :  11:00 AM
// Description: Class for Month Wise Area/Territory/Distributor Wise Target vs Ach.
...
{
    class rptMonthWiseAreaTerritoryDistributorWiseTargetvsAchievement
    {
    ...
    public class rptMonthWiseAreaTerritoryDistributorWiseTargetvsAchievements : CollectionBase
    {
        ...
        public void AreaWiseSalesvsTargetAll(DateTime dbFromDate, DateTime dbTODate)
        {
            InnerList.Clear();
            ...
            sSql = @"
                    ...
                    and perioddate between '01-Jan-2010' and '31-Dec-2013'  and a.MarketGroupID = b.customerid and channelid = 2 and a.ProductGroupID = c.ProductID
        ...
        public void AreaWiseSalesvsTargetASG(DateTime dbFromDate, DateTime dbTODate, string sASG)
        {
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
            string sSql = "";
        ...
        public void AreaWiseSalesvsTargetBrand(DateTime dbFromDate, DateTime dbTODate, string sBrand)
        {
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
            string sSql = "";
        ...
        public void AreaWiseSalesvsTargetBrandASG(DateTime dbFromDate, DateTime dbTODate, string sBrand, string sASG)
        {
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
            string sSql = "";
