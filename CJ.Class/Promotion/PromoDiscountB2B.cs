...
namespace CJ.Class.Promotion
{
    public class PromoDiscountB2B
    {
        ...
        public void Add()
        {
            ...
            try
            {
                sSql = "SELECT MAX([B2BDiscountID]) FROM t_PromoDiscountB2B";
                ...
                sSql = "INSERT INTO t_PromoDiscountB2B (B2BDiscountID, CustomerID, DiscountPercent, Status, IsActive, EffectiveDate, CreateUserID, CreateUserDate) VALUES(?,?,?,?,?,?,?,?)";
                cmd.CommandText = sSql;
        ...
        public void AddForPOS()
        {
            ...
            try
            {
                sSql = "INSERT INTO t_PromoDiscountB2B (B2BDiscountID, CustomerID, DiscountPercent, Status, IsActive, EffectiveDate, CreateUserID, CreateUserDate, ApproveUserID, ApproveDate, UpdateUserID, UpdateDate) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
        ...
        public void EditForPOS()
        {
            ...
            try
            {
                sSql = "UPDATE t_PromoDiscountB2B SET CustomerID = ?, DiscountPercent = ?, Status = ?, IsActive = ?, EffectiveDate = ?, ApproveUserID = ?, ApproveDate = ?, UpdateUserID = ?, UpdateDate = ? WHERE B2BDiscountID = ?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
        ...
        public void Edit()
        {
            ...
            try
            {
                sSql = "UPDATE t_PromoDiscountB2B SET CustomerID = ?, DiscountPercent = ?, Discount = ?, Status = ?, IsActive = ?, EffectiveDate = ?, CreateUserID = ?, CreateUserDate = ?, ApproveUserID = ?, ApproveDate = ?, UpdateUserID = ?, UpdateDate = ? WHERE B2BDiscountID = ?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
        ...
        public void EditByB2BDiscount()
        {
            ...
            try
            {
                sSql = "UPDATE t_PromoDiscountB2B SET CustomerID = ?,IsActive = ?,EffectiveDate=?, DiscountPercent=?, UpdateUserID = ?, UpdateDate = ? WHERE B2BDiscountID = ?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("CustomerID", _nCustomerID);
                cmd.Parameters.AddWithValue("IsActive", _nIsActive);
        ...
        public void ApprovedB2BDiscount()
        {
            ...
            try
            {
                sSql = "Update t_PromoDiscountB2B set status=" + (int)Dictionary.B2BDiscountStatus.Approved + ", ApproveUserID=" + nApprovedUserID + ",ApproveDate= '" + dApprovedDate + "' WHERE B2BDiscountID=?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("B2BDiscountID", _nB2BDiscountID);
                cmd.ExecuteNonQuery();
        ...
        public void UpdateStatus(int nIsActive)
        {
            OleDbCommand cmd = DBController.Instance.GetCommand();
            int nApprovedUserID = Utility.UserId;
            ...
            try
            {
                sSql = "Update t_PromoDiscountB2B set IsActive=" + nIsActive + ", UpdateUserID=" + Utility.UserId + ",UpdateDate= '" + DateTime.Now.Date + "' WHERE B2BDiscountID = ?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("B2BDiscountID", _nB2BDiscountID);
                cmd.ExecuteNonQuery();
        ...
        public void UpdateIsActive()
        {
            ...
            try
            {
                sSql = "Update t_PromoDiscountB2B set IsActive=" + (int)Dictionary.IsActive.InActive + ", UpdateUserID = " + Utility.UserId + ", UpdateDate = " + DateTime.Now.Date + " WHERE B2BDiscountID = ?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("B2BDiscountID", _nB2BDiscountID);
                cmd.ExecuteNonQuery();
        ...
        public void Delete()
        {
            ...
            try
            {
                sSql = "DELETE FROM t_PromoDiscountB2B WHERE [B2BDiscountID]=?";
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("B2BDiscountID", _nB2BDiscountID);
                cmd.ExecuteNonQuery();
        ...
        public void Refresh()
        {
            ...
            try
            {
                cmd.CommandText = "SELECT * FROM t_PromoDiscountB2B where B2BDiscountID =?";
                cmd.Parameters.AddWithValue("B2BDiscountID", _nB2BDiscountID);
                cmd.CommandType = CommandType.Text;
        ...
        public bool GetB2bCustomer()
        {
            OleDbCommand cmd = DBController.Instance.GetCommand();
            int nCount = 0;
            try
            {
                cmd.CommandText = "Select * From t_PromoDiscountB2B where CustomerID=? and IsActive=" + (int)Dictionary.IsActive.Active + "";
                cmd.Parameters.AddWithValue("CustomerID", _nCustomerID);
                cmd.CommandType = CommandType.Text;
                IDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
    ...
    public class PromoDiscountB2Bs : CollectionBase
    {
        public PromoDiscountB2B this[int i]
        {
            get { return (PromoDiscountB2B)InnerList[i]; }
            set { InnerList[i] = value; }
        }
        public void Add(PromoDiscountB2B oDiscountB2B)
        {
        ...
        public void Refresh()
        {
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
            string sSql = "SELECT * FROM t_PromoDiscountB2B";
            try
            {
                cmd.CommandText = sSql;
                cmd.CommandType = CommandType.Text;
        ...
        public void RefreshByB2BDiscount(string sCode, int nStatus)
        {
            InnerList.Clear();
            OleDbCommand cmd = DBController.Instance.GetCommand();
            string sSql = "SELECT B2BDiscountID,a.CustomerID, CustomerCode,CustomerName, DiscountPercent, a.Status, a.IsActive, EffectiveDate, u.UserName, a.CreateUserDate, a.ApproveUserID, a.ApproveDate FROM t_PromoDiscountB2B a, t_Customer b, t_user u where a.CustomerID=b.CustomerID and u.UserID = a.CreateUserID";
