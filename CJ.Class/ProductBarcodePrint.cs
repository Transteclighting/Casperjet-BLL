...
// Date: March 02, 2011
// Time : 10:00 AM
// Description: Class for Print Generate Barcode 
...
namespace CJ.Class
{
    ...
    public class ProductBarcodePrint
    {
        ...
        public static MemoryStream CreateBarcode128b(string input)
        {
            ...
            StreamReader sr = new StreamReader(assembly.GetManifestResourceStream("CJ.Class.ProductBarcodeData.txt"));
            ...
            bmp = new Bitmap(bitmapLength, 25);
        ...
        private static void Draw(int bars, bool bar)
        {
            for (int i = bars; i > 0; i--)
            {
                ...
                {
                    //draw bar
                    g.DrawLine(pBlack, barX, 0, barX, 25);
                }
                else
                {
                    //draw space
                    g.DrawLine(pWhite, barX, 0, barX, 25);
                }
                barX++;
            }
        }
        ...
        {
            // Get assembly info
            Assembly assembly = Assembly.GetAssembly(typeof(ProductBarcodePrint));
