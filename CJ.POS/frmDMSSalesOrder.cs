...
namespace CJ.POS
{
    public partial class frmDMSSalesOrder : Form
    {
        ...
        private void btnUpdateHOStock_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow oRow in dgvLineItem.Rows)
            {
                ...
                if (oRow.Index < dgvLineItem.Rows.Count - 1)
                {
                    ...
                    int nProductID = int.Parse(oRow.Cells[8].Value.ToString());
        ...
        public DMSSecondarySalesOrder GetUIData(DMSSecondarySalesOrder _oDMSSecondarySalesOrder)
        {
            ...
            _oDMSSecondarySalesOrder.ParentCustomerId = oSystemInfo.CustomerID;
            ...
            _oDMSSecondarySalesOrder.WarehouseID = oSystemInfo.WarehouseID;
            _oDMSSecondarySalesOrder.SalesType = _nSalesType;
            _oDMSSecondarySalesOrder.Shortcode = oSystemInfo.Shortcode;
            _oDMSSecondarySalesOrder.OrderType = cmbOrderType.Text;
            _oDMSSecondarySalesOrder.CreateDate = DateTime.Now.Date;
            _oDMSSecondarySalesOrder.CreateUserID = Utility.UserId;
            //_oDMSSecondarySalesOrder.OrderID = _nOrderID;
            //_oDMSSecondarySalesOrder.OrderNo = _sOrderNo;
            ...
            foreach (DataGridViewRow oItemRow in dgvLineItem.Rows)
            {
                if (oItemRow.Index < dgvLineItem.Rows.Count - 1)
                {
                    ...
                    _oDMSSecondarySalesOrderDetail.WarehouseID = oSystemInfo.WarehouseID;
            ...
            if (this.Tag != null)
            {
                if (ValidateUIInput())
                {
                    try
                    {
                        ...
                        _oDataTranDMS.DataID = Convert.ToInt32(_oDMSSecondarySalesOrder.OrderID);
                        _oDataTranDMS.WarehouseID = _oDMSSecondarySalesOrder.WarehouseID;
