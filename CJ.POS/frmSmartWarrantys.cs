...
namespace CJ.POS
{
    public partial class frmSmartWarrantys : Form
    {
        ...
        private void DataLoadControl()
        {
            ...
            _oExtendedWarrantys.RefreshForPOS(isCreateDateRangeChecked, dFromDate.Value.Date, dToDate.Value.Date, txtConsumerName.Text.Trim(), txtMobileNo.Text, ctlProduct1.txtCode.Text, txtProductSerialNo.Text, txtCertificateNo.Text, cmbPaymentMode.Text, cmbSmartWarrantyTenure.Text);
